...
public class DiagramStructureMergeViewer extends StructuredViewer {
	...
	public DiagramStructureMergeViewer(Composite parent,
		...
		setContentProvider(new StructureMergeContentProvider(
				compareConfiguration));
	...
	protected void inputChanged(Object input, Object oldInput) {
		...
		if (!(input instanceof ModelInputSnapshot) && input != oldInput) {
			...
			setInput(KivikComparator.getComparator(compareConfiguration)
					.getComparisonResult());
		} else {
			Diagram diagram = KivikComparator.getComparator(
					compareConfiguration).getMergedViewModel();
