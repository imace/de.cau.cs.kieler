...
import edu.unikiel.rtsys.kieler.kiml.layout.KimlLayoutGraph.EDGE_TYPES;
 ...
 * <ul>
 *   <li>{@link edu.unikiel.rtsys.kieler.kiml.layout.KimlLayoutGraph.impl.kEdgeLayoutImpl#getSourcePoint <em>Source Point</em>}</li>
...
public class kEdgeLayoutImpl extends EObjectImpl implements kEdgeLayout {
	 ...
	 * @ordered
	 */
	protected static final EDGE_TYPES EDGE_TYPE_EDEFAULT = EDGE_TYPES.NONE;
	 ...
	 * @ordered
	 */
	protected EDGE_TYPES edgeType = EDGE_TYPE_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setEdgeType(EDGE_TYPES newEdgeType) {
		EDGE_TYPES oldEdgeType = edgeType;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case KimlLayoutGraphPackage.KEDGE_LAYOUT__GRID_POINTS:
				...
				return;
			case KimlLayoutGraphPackage.KEDGE_LAYOUT__EDGE_TYPE:
				setEdgeType((EDGE_TYPES)newValue);
				return;
		}
