...
public class GroupAsCircle extends KimlAbstractAction {

	private String layoutType = KimlLayoutHintConstants.CIRCLE;
	...
	public void run(IAction action) {
		...
		KimlLayoutHintHelper.setLayoutHint(selectedNodeElements, groupID, layoutType);
