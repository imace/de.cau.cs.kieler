...
public interface KimlLayoutGraphPackage extends EPackage {
     ...
     * @ordered
     */
    int KEDGE_LABEL__PARENT_EDGE = KLABEL_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
	int KEDGE_LABEL_FEATURE_COUNT = KLABEL_FEATURE_COUNT + 2;
	...
	/**
     * Returns the meta object for the container reference '{@link de.cau.cs.kieler.kiml.layout.KimlLayoutGraph.KEdgeLabel#getParentEdge <em>Parent Edge</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the container reference '<em>Parent Edge</em>'.
     * @see de.cau.cs.kieler.kiml.layout.KimlLayoutGraph.KEdgeLabel#getParentEdge()
     * @see #getKEdgeLabel()
     * @generated
     */
    EReference getKEdgeLabel_ParentEdge();
	...
	interface Literals {
         ...
         * @generated
         */
        EReference KEDGE_LABEL__PARENT_EDGE = eINSTANCE.getKEdgeLabel_ParentEdge();
