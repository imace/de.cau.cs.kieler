...
public class DotLayoutProvider extends KimlAbstractLayoutProvider {
	...
	private final static String LAYOUT_PROVIDER_NAME = GraphvizLayoutProviderNames.GRAPHVIZ_DOT;
	private final static LAYOUT_TYPE LAYOUT_PROVIDER_LAYOUT_TYPE = LAYOUT_TYPE.HIERARCHICAL;
