...
public class DotLayoutProvider extends KimlAbstractLayoutProvider {
	...
	public final static String LAYOUT_PROVIDER_NAME = GraphvizLayoutProviderNames.GRAPHVIZ_DOT;
	public final static LAYOUT_TYPE LAYOUT_PROVIDER_LAYOUT_TYPE = LAYOUT_TYPE.HIERARCHICAL;
