...
public class CircoLayoutProvider extends KimlAbstractLayoutProvider {
	...
	private final static String LAYOUT_PROVIDER_NAME = GraphvizLayoutProviderNames.GRAPHVIZ_CIRCO;
	private final static LAYOUT_TYPE LAYOUT_PROVIDER_LAYOUT_TYPE = LAYOUT_TYPE.CIRCLE;
