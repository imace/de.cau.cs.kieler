...
public class gv {
  ...
  public static boolean render(SWIGTYPE_p_Agraph_t g, String format, String filename) {
    return gvJNI.render__SWIG_2(SWIGTYPE_p_Agraph_t.getCPtr(g), format, filename);
  }

  public static boolean render(SWIGTYPE_p_Agraph_t g, String format, SWIGTYPE_p_FILE f) {
    return gvJNI.render__SWIG_3(SWIGTYPE_p_Agraph_t.getCPtr(g), format, SWIGTYPE_p_FILE.getCPtr(f));
  }
