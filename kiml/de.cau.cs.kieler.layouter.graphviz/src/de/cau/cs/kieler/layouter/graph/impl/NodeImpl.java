 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getParentGraph <em>Parent Graph</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getOutgoingEdges <em>Outgoing Edges</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getIncomingEdges <em>Incoming Edges</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getData <em>Data</em>}</li>
 *   <li>{@link de.cau.cs.kieler.layouter.graph.impl.NodeImpl#getParentNode <em>Parent Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
