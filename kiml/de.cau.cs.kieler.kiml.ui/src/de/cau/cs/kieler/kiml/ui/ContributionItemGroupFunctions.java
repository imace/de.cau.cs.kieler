...
public class ContributionItemGroupFunctions extends CompoundContributionItem {
	...
	public static final String HIGHLIGHT_GROUP_MEMBERS = "de.cau.cs.kieler.kiml.ui.command.highlightGroupMembers";
	public static final String SELECT_GROUP_MEMBERS = "de.cau.cs.kieler.kiml.ui.command.selectGroupMembers";
	public static final String UNGROUP_ELEMENTS = "de.cau.cs.kieler.kiml.ui.command.ungroupElements";
