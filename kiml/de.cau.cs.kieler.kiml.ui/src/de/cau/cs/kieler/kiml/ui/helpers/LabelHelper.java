 ...
 * 
 * Mainly taken from 
 * org.eclipse.gmf.runtime.diagram.ui.internal.figures.LabelHelper
 *
 * Changed some visibilities such that lower level methods can be
 * accessed from outside. Especially it should be possible to
 * set lists of bend points from outside to cover use cases where both the
 * label and its parent edge will change in the future and you need
 * to calculate its future position.
 * 
 * @author haf
 */
