...
import de.cau.cs.kieler.kiml.ui.ContributionItemGroupFunctions;
...
public class GroupFunctionHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		 ...
		 */
		if (commandID
				.equals("de.cau.cs.kieler.kiml.ui.command.selectGroupMembers")) {
		 ...
		 */
		if (commandID
				.equals("de.cau.cs.kieler.kiml.ui.command.highlightGroupMembers")) {
			if (selectedNodeElements.size() == 1) {
		 ...
		 */
		if (commandID
				.equals("de.cau.cs.kieler.kiml.ui.command.ungroupElements")) {
