...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.layouter.graph.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Label_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Label_data_feature", "_UI_Label_type"),
				 GraphPackage.Literals.LABEL__DATA,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphPackage.Literals.LABEL__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphPackage.Literals.LABEL__POSITION);
			childrenFeatures.add(GraphPackage.Literals.LABEL__SIZE);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((Label)object).getData();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.LABEL__POSITION,
				 GraphFactory.eINSTANCE.createCoordinates()));

		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.LABEL__SIZE,
