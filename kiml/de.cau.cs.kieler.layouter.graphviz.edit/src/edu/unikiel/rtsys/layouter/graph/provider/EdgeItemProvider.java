...
/**
 * This is the item provider adapter for a {@link edu.unikiel.rtsys.layouter.graph.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_data_feature", "_UI_Edge_type"),
				 GraphPackage.Literals.EDGE__DATA,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphPackage.Literals.EDGE__BENDPOINTS);
			childrenFeatures.add(GraphPackage.Literals.EDGE__EDGE_LABEL);
			childrenFeatures.add(GraphPackage.Literals.EDGE__HEAD_LABEL);
			childrenFeatures.add(GraphPackage.Literals.EDGE__TAIL_LABEL);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((Edge)object).getData();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.EDGE__BENDPOINTS,
				 GraphFactory.eINSTANCE.createCoordinates()));

		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.EDGE__EDGE_LABEL,
				 GraphFactory.eINSTANCE.createLabel()));

		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.EDGE__HEAD_LABEL,
				 GraphFactory.eINSTANCE.createLabel()));

		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.EDGE__TAIL_LABEL,
				 GraphFactory.eINSTANCE.createLabel()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == GraphPackage.Literals.EDGE__EDGE_LABEL ||
			childFeature == GraphPackage.Literals.EDGE__HEAD_LABEL ||
			childFeature == GraphPackage.Literals.EDGE__TAIL_LABEL;
