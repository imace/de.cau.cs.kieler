 ...
 * @generated
 */
public class WritesDataToCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public WritesDataToCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && !(target instanceof Information)) {
			return false;
		}
		if (getSource() == null) {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateWritesDataTo_3003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.WritesDataTo newElement = (edu.unikiel.informatik.aiw.generated.epc.WritesDataTo) super.doDefaultElementCreation();
		WritesDataTo newElement = EpcFactory.eINSTANCE.createWritesDataTo();
	 ...
	 * @generated
	 */
	protected Information getTarget() {
