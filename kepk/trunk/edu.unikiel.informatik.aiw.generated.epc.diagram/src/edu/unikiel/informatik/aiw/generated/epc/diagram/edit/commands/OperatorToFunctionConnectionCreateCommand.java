 ...
 * @generated
 */
public class OperatorToFunctionConnectionCreateCommand extends
	 ...
	 * @generated
	 */
	public OperatorToFunctionConnectionCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && !(source instanceof LogicalOperator)) {
			return false;
		}
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateOperatorToFunctionConnection_3008(getContainer(),
						getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.OperatorToFunctionConnection newElement = (edu.unikiel.informatik.aiw.generated.epc.OperatorToFunctionConnection) super.doDefaultElementCreation();
		OperatorToFunctionConnection newElement = EpcFactory.eINSTANCE
				.createOperatorToFunctionConnection();
		getContainer().getConnectors().add(newElement);
		newElement.setOperator(getSource());
		newElement.setFunction(getTarget());
		return newElement;
	}
	 ...
	 * @generated
	 */
	protected LogicalOperator getSource() {
		return (LogicalOperator) source;
	}
