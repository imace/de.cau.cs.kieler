 ...
 * @generated
 */
public class ActivatesFunctionCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public ActivatesFunctionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateActivatesFunction_3004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.ActivatesFunction newElement = (edu.unikiel.informatik.aiw.generated.epc.ActivatesFunction) super.doDefaultElementCreation();
		ActivatesFunction newElement = EpcFactory.eINSTANCE
				.createActivatesFunction();
