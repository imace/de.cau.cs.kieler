 ...
 * @generated
 */
public class OperatorToEventConnectionCreateCommand extends
	 ...
	 * @generated
	 */
	public OperatorToEventConnectionCreateCommand(
	...
	public boolean canExecute() {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateOperatorToEventConnection_3007(getContainer(),
						getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.OperatorToEventConnection newElement = (edu.unikiel.informatik.aiw.generated.epc.OperatorToEventConnection) super.doDefaultElementCreation();
		OperatorToEventConnection newElement = EpcFactory.eINSTANCE
				.createOperatorToEventConnection();
		getContainer().getConnectors().add(newElement);
		newElement.setOperator(getSource());
		newElement.setEvent(getTarget());
		return newElement;
	}
