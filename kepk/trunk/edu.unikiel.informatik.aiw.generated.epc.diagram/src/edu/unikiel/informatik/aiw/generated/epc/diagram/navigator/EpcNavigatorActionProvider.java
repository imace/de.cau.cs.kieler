...
import edu.unikiel.informatik.aiw.generated.epc.diagram.part.EpcDiagramEditor;
 ...
 * @generated
 */
public class EpcNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EpcNavigatorItem) {
					selectedElement = ((EpcNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EpcDiagramEditor.ID);
