package edu.unikiel.informatik.aiw.generated.epc.diagram.expressions;
...
public abstract class EpcAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(EpcDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected EpcAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	public static final EpcAbstractExpression createNullExpression(
			EClassifier context) {
		return new EpcAbstractExpression(context) {
