 ...
 * @generated
 */
public class EventToOperatorConnectionCreateCommand extends
	 ...
	 * @generated
	 */
	public EventToOperatorConnectionCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && !(source instanceof Event)) {
			return false;
		}
		if (target != null && !(target instanceof LogicalOperator)) {
			return false;
		}
		if (getSource() == null) {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateEventToOperatorConnection_3005(getContainer(),
						getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.EventToOperatorConnection newElement = (edu.unikiel.informatik.aiw.generated.epc.EventToOperatorConnection) super.doDefaultElementCreation();
		EventToOperatorConnection newElement = EpcFactory.eINSTANCE
				.createEventToOperatorConnection();
		getContainer().getConnectors().add(newElement);
		newElement.setEvent(getSource());
		newElement.setOperator(getTarget());
		return newElement;
	}
	 ...
	 * @generated
	 */
	protected LogicalOperator getTarget() {
		return (LogicalOperator) target;
	}
