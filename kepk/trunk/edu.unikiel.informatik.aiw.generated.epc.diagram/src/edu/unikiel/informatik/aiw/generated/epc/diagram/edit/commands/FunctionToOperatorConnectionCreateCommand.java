 ...
 * @generated
 */
public class FunctionToOperatorConnectionCreateCommand extends
	 ...
	 * @generated
	 */
	public FunctionToOperatorConnectionCreateCommand(
	...
	public boolean canExecute() {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateFunctionToOperatorConnection_3006(getContainer(),
						getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.unikiel.informatik.aiw.generated.epc.FunctionToOperatorConnection newElement = (edu.unikiel.informatik.aiw.generated.epc.FunctionToOperatorConnection) super.doDefaultElementCreation();
		FunctionToOperatorConnection newElement = EpcFactory.eINSTANCE
				.createFunctionToOperatorConnection();
		getContainer().getConnectors().add(newElement);
		newElement.setFunction(getSource());
