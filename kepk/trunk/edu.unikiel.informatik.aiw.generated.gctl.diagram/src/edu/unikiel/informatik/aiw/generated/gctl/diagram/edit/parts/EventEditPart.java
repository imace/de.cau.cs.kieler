...
import edu.unikiel.informatik.aiw.generated.gctl.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
				.DPtoLP(85), getMapMode().DPtoLP(49));
		return result;
	}
	...
	public class EventFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureEventNameFigure;
		...
		public EventFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(85),
		...
		private void createContents() {
			...
			class EventFigure0Class extends Shape {
				/**
				 * @generated
				 */
			...
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(0)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(60),
					getMapMode().DPtoLP(0)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(70),
					getMapMode().DPtoLP(15)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(60),
					getMapMode().DPtoLP(30)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(30)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(15)));
			eventFigure0.addPoint(new Point(getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(0)));
			...
			eventFigure0.setLayoutManager(new StackLayout());

			fFigureEventNameFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureEventNameFigure() {
