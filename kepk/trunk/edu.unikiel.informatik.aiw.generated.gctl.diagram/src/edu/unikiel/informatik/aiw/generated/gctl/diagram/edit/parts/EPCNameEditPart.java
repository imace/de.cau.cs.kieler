 ...
 * @generated
 */
public class EPCNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EPCNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new EpcParserProvider.HintAdapter(
					EpcElementTypes.EPC_1004, getParserElement(), parserHint);
