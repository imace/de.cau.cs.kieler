...
import edu.unikiel.informatik.aiw.generated.gctl.diagram.providers.EpcMarkerNavigationProvider;
import edu.unikiel.informatik.aiw.generated.gctl.diagram.providers.EpcValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		EpcValidationProvider.runWithConstraints(view, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			EpcMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		EpcMarkerNavigationProvider.addMarker(target, elementId, location,
