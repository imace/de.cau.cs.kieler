...
import edu.unikiel.informatik.aiw.generated.gctl.diagram.edit.policies.EpcTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InformationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InformationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new EpcParserProvider.HintAdapter(
					EpcElementTypes.Information_1003, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), EpcEditPartFactory
