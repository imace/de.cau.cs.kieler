...
import edu.unikiel.informatik.aiw.generated.gctl.diagram.part.EpcDiagramUpdater;
import edu.unikiel.informatik.aiw.generated.gctl.diagram.part.EpcLinkDescriptor;
import edu.unikiel.informatik.aiw.generated.gctl.diagram.part.EpcNodeDescriptor;
import edu.unikiel.informatik.aiw.generated.gctl.diagram.part.EpcVisualIDRegistry;

/**
 * @generated
 */
public class GCTLCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!GCTLEditPart.MODEL_ID.equals(EpcVisualIDRegistry.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case FunctionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EpcDiagramUpdater
						.getFunction_1001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EventEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EpcDiagramUpdater
						.getEvent_1002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
			...
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(EpcDiagramUpdater
								.getEPC_1004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ImplicationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EpcDiagramUpdater
						.getImplication_1005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case GCTLconnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EpcDiagramUpdater
						.getGCTLconnector_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
