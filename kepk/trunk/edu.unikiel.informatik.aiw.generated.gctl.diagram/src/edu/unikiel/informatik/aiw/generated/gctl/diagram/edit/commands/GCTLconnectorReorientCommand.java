 ...
 * @generated
 */
public class GCTLconnectorReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GCTLconnectorReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (!(getElementToEdit() instanceof GCTLconnector)) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistGCTLconnector_3001(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		edu.unikiel.informatik.aiw.generated.epc.EPC container = (edu.unikiel.informatik.aiw.generated.epc.EPC) getLink()
				.eContainer();
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistGCTLconnector_3001(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GCTLconnector getLink() {
		return (GCTLconnector) getElementToEdit();
	}
