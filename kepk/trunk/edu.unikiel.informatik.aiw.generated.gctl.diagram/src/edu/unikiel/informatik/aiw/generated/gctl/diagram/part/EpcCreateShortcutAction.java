...
import edu.unikiel.informatik.aiw.generated.gctl.diagram.edit.commands.EpcCreateShortcutDecorationsCommand;
...
public class EpcCreateShortcutAction implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private GCTLEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof GCTLEditPart) {
				mySelectedElement = (GCTLEditPart) structuredSelection
						.getFirstElement();
			}
		}
