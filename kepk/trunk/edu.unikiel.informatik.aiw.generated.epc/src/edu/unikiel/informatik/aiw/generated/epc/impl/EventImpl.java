 ...
 * <ul>
 *   <li>{@link edu.unikiel.informatik.aiw.generated.epc.impl.EventImpl#isShowInEPCEditor <em>Show In EPC Editor</em>}</li>
 *   <li>{@link edu.unikiel.informatik.aiw.generated.epc.impl.EventImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends EObjectImpl implements Event {
	...
	public void setShowInEPCEditor(boolean newShowInEPCEditor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EpcPackage.EVENT__SHOW_IN_EPC_EDITOR, oldShowInEPCEditor, showInEPCEditor));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EpcPackage.EVENT__NAME, oldName, name));
	}
