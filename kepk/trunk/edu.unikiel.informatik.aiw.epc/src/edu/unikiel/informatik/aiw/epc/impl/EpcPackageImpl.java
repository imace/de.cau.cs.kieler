...
import edu.unikiel.informatik.aiw.epc.ActivatesFunction;
import edu.unikiel.informatik.aiw.epc.EPCObject;
import edu.unikiel.informatik.aiw.epc.EpcFactory;
import edu.unikiel.informatik.aiw.epc.EpcPackage;
import edu.unikiel.informatik.aiw.epc.Event;
import edu.unikiel.informatik.aiw.epc.Function;
import edu.unikiel.informatik.aiw.epc.Information;
import edu.unikiel.informatik.aiw.epc.LogicalOperator;
import edu.unikiel.informatik.aiw.epc.Node;
import edu.unikiel.informatik.aiw.epc.ProvidesDataTo;
import edu.unikiel.informatik.aiw.epc.Relationship;
import edu.unikiel.informatik.aiw.epc.SuccessorOf;
import edu.unikiel.informatik.aiw.epc.TriggersEvent;
...
public class EpcPackageImpl extends EPackageImpl implements EpcPackage {
	 ...
	 * @see edu.unikiel.informatik.aiw.epc.EpcPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(epcEClass, edu.unikiel.informatik.aiw.epc.EPC.class, "EPC", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEPC_Connectors(), this.getRelationship(), null, "connectors", null, 0, -1, edu.unikiel.informatik.aiw.epc.EPC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEPC_Objects(), this.getEPCObject(), null, "objects", null, 0, -1, edu.unikiel.informatik.aiw.epc.EPC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(xorEClass, edu.unikiel.informatik.aiw.epc.XOR.class, "XOR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(orEClass, edu.unikiel.informatik.aiw.epc.OR.class, "OR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(andEClass, edu.unikiel.informatik.aiw.epc.AND.class, "AND", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
