...
/**
 * This is the item provider adapter for a {@link edu.unikiel.informatik.aiw.generated.epc.Implication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImplicationItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addShowInEPCEditorPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Show In EPC Editor feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addShowInEPCEditorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EPCObject_showInEPCEditor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EPCObject_showInEPCEditor_feature", "_UI_EPCObject_type"),
				 EpcPackage.Literals.EPC_OBJECT__SHOW_IN_EPC_EDITOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EpcPackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Implication)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Implication_type") :
			getString("_UI_Implication_type") + " " + label;
	}
