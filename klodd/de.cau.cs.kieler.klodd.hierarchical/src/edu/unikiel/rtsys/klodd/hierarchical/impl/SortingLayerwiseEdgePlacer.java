...
public class SortingLayerwiseEdgePlacer extends AbstractAlgorithm implements
	...
	/* (non-Javadoc)
	 * @see edu.unikiel.rtsys.klodd.hierarchical.modules.ILayerwiseEdgePlacer#placeEdges(edu.unikiel.rtsys.klodd.hierarchical.structures.Layer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.unikiel.rtsys.klodd.hierarchical.modules.ILayerwiseEdgePlacer#getSlotMap()
	 */
