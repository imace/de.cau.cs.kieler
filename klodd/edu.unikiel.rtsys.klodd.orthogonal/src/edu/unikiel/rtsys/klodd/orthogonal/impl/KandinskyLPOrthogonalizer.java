...
import edu.unikiel.rtsys.klodd.orthogonal.modules.IOrthogonalizer;
...
public class KandinskyLPOrthogonalizer extends AbstractAlgorithm implements
	...
	/* (non-Javadoc)
	 * @see edu.unikiel.rtsys.klodd.orthogonal.modules.IOrthogonalizer#orthogonalize(edu.unikiel.rtsys.klodd.orthogonal.structures.TSMGraph)
	 */
