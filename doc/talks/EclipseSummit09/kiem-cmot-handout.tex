...
%HANDOUT			\only<2>{\includegraphics[scale=0.27]{images/kiem-threads.png}}
%HANDOUT			\only<3->{\includegraphics[scale=0.41]{images/kiem-view.png}}
			}
...
%HANDOUT  		\only<1>{\includegraphics[scale=0.32]{images/KlePtoOverview.png} }
...
%HANDOUT \only<1>{\hspace{0.8cm}~\includegraphics[scale=0.12]{images/segment-trains.png} }
\only<2>{\hspace{0.8cm}~\includegraphics[scale=0.12]{images/segment-trains2.png} }
\begin{itemize}
