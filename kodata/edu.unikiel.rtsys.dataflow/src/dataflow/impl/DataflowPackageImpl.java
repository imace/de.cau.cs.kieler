...
public class DataflowPackageImpl extends EPackageImpl implements DataflowPackage {
	...
	public static DataflowPackage init() {
		...
		DataflowPackageImpl theDataflowPackage = (DataflowPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof DataflowPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new DataflowPackageImpl());
