...
public class DataflowSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataflowPackage.BOX: {
				Box box = (Box)theEObject;
				T result = caseBox(box);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.CONNECTION: {
			...
			case DataflowPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.INPUT_PORT: {
			...
			case DataflowPackage.OUTPUT_PORT: {
	 ...
	 * @generated
	 */
	public T caseDataflowModel(DataflowModel object) {
		return null;
	}
