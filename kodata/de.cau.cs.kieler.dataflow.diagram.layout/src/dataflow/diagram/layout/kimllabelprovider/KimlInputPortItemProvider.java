...
import dataflow.provider.InputPortItemProvider;
import de.cau.cs.kieler.kiml.ui.provider.IKimlLabelProvider;

public class KimlInputPortItemProvider extends InputPortItemProvider implements
		IKimlLabelProvider {

	public KimlInputPortItemProvider(AdapterFactory adapterFactory) {
