...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedDiagramEditor;
 ...
 * @generated
 */
public class CakefeedNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CakefeedNavigatorItem) {
					selectedElement = ((CakefeedNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CakefeedDiagramEditor.ID);
