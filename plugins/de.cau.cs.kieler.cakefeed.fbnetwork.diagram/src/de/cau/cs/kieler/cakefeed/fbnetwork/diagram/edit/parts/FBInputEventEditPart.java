...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.policies.FBInputEventItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FBInputEventEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof FBInputEventNameEditPart) {
			BorderItemLocator locator =

			new CakefeedPortLabelLocator(getMainFigure(),
					PositionConstants.SOUTH, true);
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForSource(
		...
		if (relationshipType == CakefeedElementTypes.FBFBEventConnection_4001) {
			types.add(CakefeedElementTypes.FBOutputEvent_3002);
		}
		return types;
	}
