...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.policies.CakefeedTextSelectionEditPolicy;
 ...
 * @generated
 */
public class FBOutputEventNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				CakefeedVisualIDRegistry
						.getType(de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBOutputEventNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public FBOutputEventNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new CakefeedTextSelectionEditPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof CakefeedTextSelectionEditPolicy) {
			((CakefeedTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof CakefeedTextSelectionEditPolicy) {
			((CakefeedTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), CakefeedEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new LabelFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public class LabelFigureDescriptor extends WrappingLabel {

		/**
		 * @generated
		 */
		public LabelFigureDescriptor() {
			this.setText("");
