...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedDiagramUpdater;
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedLinkDescriptor;
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedNodeDescriptor;
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedVisualIDRegistry;

/**
 * @generated
 */
public class FBNetworkCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = CakefeedDiagramUpdater
				.getFBNetwork_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!FBNetworkEditPart.MODEL_ID.equals(CakefeedVisualIDRegistry
				.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case FBNetworkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBNetwork_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case FBInputEventEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBInputEvent_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case FBOutputEventEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBOutputEvent_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case FBInputVarEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBInputVar_3003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case FBOutputVarEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBOutputVar_3004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case FBFBEventConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBFBEventConnection_4001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case FBFBDataConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CakefeedDiagramUpdater
						.getFBFBDataConnection_4002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
