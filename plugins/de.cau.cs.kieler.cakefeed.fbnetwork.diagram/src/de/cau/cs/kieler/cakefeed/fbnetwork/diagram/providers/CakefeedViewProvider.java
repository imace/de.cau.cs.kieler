...
public class CakefeedViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FBNetworkEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FBNetworkEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case FBInputEventEditPart.VISUAL_ID:
			return createFBInputEvent_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case FBOutputEventEditPart.VISUAL_ID:
			return createFBOutputEvent_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case FBInputVarEditPart.VISUAL_ID:
			return createFBInputVar_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case FBOutputVarEditPart.VISUAL_ID:
			return createFBOutputVar_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case FBFBEventConnectionEditPart.VISUAL_ID:
			return createFBFBEventConnection_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case FBFBDataConnectionEditPart.VISUAL_ID:
			return createFBFBDataConnection_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createFBInputEvent_3001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createFBOutputEvent_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createFBInputVar_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createFBOutputVar_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Edge createFBFBEventConnection_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createFBFBDataConnection_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!FBNetworkEditPart.MODEL_ID.equals(CakefeedVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", FBNetworkEditPart.MODEL_ID); //$NON-NLS-1$
