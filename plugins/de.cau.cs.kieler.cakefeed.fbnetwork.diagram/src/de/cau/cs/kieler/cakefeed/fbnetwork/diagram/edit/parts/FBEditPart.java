...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.policies.FBCanonicalEditPolicy;
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.policies.FBItemSemanticEditPolicy;
...
public class FBEditPart extends AbstractBorderedShapeEditPart {
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		LayoutEditPolicy lep = new LayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				case de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputEventEditPart.VISUAL_ID:
				case de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBOutputEventEditPart.VISUAL_ID:
				case de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputVarEditPart.VISUAL_ID:
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputEventEditPart) {
			...
			getBorderedFigure()
					...
					.add(
							((de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputEventEditPart) childEditPart)
									.getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBOutputEventEditPart) {
			BorderItemLocator locator =
			...
			getBorderedFigure()
					.getBorderItemContainer()
					.add(
							((de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBOutputEventEditPart) childEditPart)
									.getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputVarEditPart) {
			BorderItemLocator locator =
			...
			getBorderedFigure()
					.getBorderItemContainer()
					.add(
							((de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.parts.FBInputVarEditPart) childEditPart)
									.getFigure(), locator);
			return true;
		}
							...
							for (int i = 0; i < 4; i++) {
								...
								for (EObject o : list) {
									...
									if (o instanceof IFInputEvent) {
										elementType = CakefeedElementTypes.FBInputEvent_3001;
									} else if (o instanceof IFOutputEvent) {
										elementType = CakefeedElementTypes.FBOutputEvent_3002;
									} else if (o instanceof IFInputVar) {
										elementType = CakefeedElementTypes.FBInputVar_3003;
									} else if (o instanceof IFOutputVar) {
										elementType = CakefeedElementTypes.FBOutputVar_3004;
									}
									if (elementType != null) {
