...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.part.CakefeedDiagramEditorUtil;

/**
 * @generated
 */
public class CakefeedMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = CakefeedDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			CakefeedDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
