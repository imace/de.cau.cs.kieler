...
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.commands.FBFBDataConnectionCreateCommand;
import de.cau.cs.kieler.cakefeed.fbnetwork.diagram.edit.commands.FBFBDataConnectionReorientCommand;
...
public class FBOutputVarItemSemanticEditPolicy extends
	...
	public FBOutputVarItemSemanticEditPolicy() {
		super(CakefeedElementTypes.FBOutputVar_3004);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CakefeedElementTypes.FBFBDataConnection_4002 == req
				.getElementType()) {
