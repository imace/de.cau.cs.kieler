 ...
 * @generated
 */
public class CakefeedValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = CakefeedDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CakefeedDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& FBNetworkEditPart.MODEL_ID.equals(CakefeedVisualIDRegistry
						.getModelID(view));
	}
