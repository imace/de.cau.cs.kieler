...
public class ExampleSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ExamplePackage.SIGNAL_REFERENCE:
      {
      ...
      case ExamplePackage.EXPRESSION:
      {
