...
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.policies.FBOutputVarItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FBOutputVarEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FBOutputVarEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FBOutputVarItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		FBOutputVarFigureDescriptor figure = new FBOutputVarFigureDescriptor();
	 ...
	 * @generated
	 */
	public FBOutputVarFigureDescriptor getPrimaryShape() {
		return (FBOutputVarFigureDescriptor) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FBOutputVarNameEditPart) {
			((FBOutputVarNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFBOVLabel());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class FBOutputVarFigureDescriptor extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureFBOVLabel;

		/**
		 * @generated
		 */
		public FBOutputVarFigureDescriptor() {
		...
		private void createContents() {
			...
			fFigureFBOVLabel = new WrappingLabel();
			fFigureFBOVLabel.setText("");

			this.add(fFigureFBOVLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFBOVLabel() {
			return fFigureFBOVLabel;
		}
