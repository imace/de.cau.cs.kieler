				...
				for (Iterator cit = node.getChildren().iterator(); cit
					...
					case FBInputEventEditPart.VISUAL_ID:
						for (Iterator it = cnode.getTargetEdges().iterator(); it
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(incomingLink) == IFFBEventConnectionEditPart.VISUAL_ID) {
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(incomingLink) == FBFBEventConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
					...
					case FBOutputEventEditPart.VISUAL_ID:
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(outgoingLink) == FBIFEventConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(outgoingLink) == FBFBEventConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
					...
					case FBInputVarEditPart.VISUAL_ID:
						for (Iterator it = cnode.getTargetEdges().iterator(); it
							...
							Edge incomingLink = (Edge) it.next();
							if (CakefeedVisualIDRegistry
									.getVisualID(incomingLink) == IFFBDataConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(incomingLink) == FBFBDataConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
					...
					case FBOutputVarEditPart.VISUAL_ID:
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							Edge outgoingLink = (Edge) it.next();
							if (CakefeedVisualIDRegistry
									.getVisualID(outgoingLink) == FBIFDataConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (CakefeedVisualIDRegistry
									.getVisualID(outgoingLink) == FBFBDataConnectionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
