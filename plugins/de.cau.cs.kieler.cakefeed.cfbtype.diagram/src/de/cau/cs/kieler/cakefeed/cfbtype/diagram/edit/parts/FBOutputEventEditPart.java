...
import de.cau.cs.kieler.cakefeed.custom.CakefeedPortLabelLocator;
import de.cau.cs.kieler.cakefeed.custom.FBTypeFigure;

/**
 * @generated
 */
public class FBOutputEventEditPart extends BorderedBorderItemEditPart {
	...
	protected IFigure createNodeShape() {
		IFigure figure = new FBEventFigureDescriptor();
	 ...
	 * @generated
	 */
	public FBEventFigureDescriptor getPrimaryShape() {
		return (FBEventFigureDescriptor) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof FBOutputEventNameEditPart) {
			BorderItemLocator locator =

			new CakefeedPortLabelLocator(getMainFigure(),
					PositionConstants.SOUTH, false);
	 ...
	 * @generated
	 */
	public class FBEventFigureDescriptor extends RectangleFigure {
		 ...
		 * @generated
		 */
		public FBEventFigureDescriptor() {
			this.setLineWidth(1);
