 ...
 * @generated
 */
public class IFIFDataConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IFIFDataConnectionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof IFIFDataConnection) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return CakefeedBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIFIFDataConnection_4011(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		CFBType container = (CFBType) getLink().eContainer();
		return CakefeedBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIFIFDataConnection_4011(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected IFIFDataConnection getLink() {
		return (IFIFDataConnection) getElementToEdit();
	}
