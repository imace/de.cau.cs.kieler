...
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.commands.IFIFDataConnectionCreateCommand;
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.commands.IFIFDataConnectionReorientCommand;
 ...
 * @generated
 */
public class IFOutputVarItemSemanticEditPolicy extends
		CakefeedBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public IFOutputVarItemSemanticEditPolicy() {
		super(CakefeedElementTypes.IFOutputVar_3015);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CakefeedElementTypes.IFIFDataConnection_4011 == req
				.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CakefeedElementTypes.IFIFDataConnection_4011 == req
				.getElementType()) {
			return getGEFWrapper(new IFIFDataConnectionCreateCommand(req, req
					.getSource(), req.getTarget()));
		}
		if (CakefeedElementTypes.FBIFDataConnection_4013 == req
				.getElementType()) {
	...
	protected Command getReorientRelationshipCommand(
		...
		case IFIFDataConnectionEditPart.VISUAL_ID:
			return getGEFWrapper(new IFIFDataConnectionReorientCommand(req));
