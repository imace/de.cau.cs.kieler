...
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.policies.FBInputVarItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FBInputVarEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FBInputVarEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FBInputVarItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		FBInputVarFigureDescriptor figure = new FBInputVarFigureDescriptor();
	 ...
	 * @generated
	 */
	public FBInputVarFigureDescriptor getPrimaryShape() {
		return (FBInputVarFigureDescriptor) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FBInputVarNameEditPart) {
			((FBInputVarNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureFBIVLabel());
			return true;
		}
		return false;
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForSource(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == CakefeedElementTypes.IFFBDataConnection_4012) {
			types.add(CakefeedElementTypes.IFInputVar_3014);
		}
		if (relationshipType == CakefeedElementTypes.FBFBDataConnection_4014) {
	 ...
	 * @generated
	 */
	public class FBInputVarFigureDescriptor extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureFBIVLabel;

		/**
		 * @generated
		 */
		public FBInputVarFigureDescriptor() {
		...
		private void createContents() {
			...
			fFigureFBIVLabel = new WrappingLabel();
			fFigureFBIVLabel.setText("");

			this.add(fFigureFBIVLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFBIVLabel() {
			return fFigureFBIVLabel;
		}
