...
public class CakefeedElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType CFBType_2002 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.CFBType_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType IFInputEvent_3021 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.IFInputEvent_3021"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType IFOutputEvent_3022 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.IFOutputEvent_3022"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType IFInputVar_3023 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.IFInputVar_3023"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType IFOutputVar_3024 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.IFOutputVar_3024"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FB_3025 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.FB_3025"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FBInputEvent_3026 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.FBInputEvent_3026"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FBOutputEvent_3027 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.FBOutputEvent_3027"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FBInputVar_3028 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.FBInputVar_3028"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FBOutputVar_3029 = getElementType("de.cau.cs.kieler.cakefeed.cfbtype.diagram.FBOutputVar_3029"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(CFBType_2002, CakefeedPackage.eINSTANCE.getCFBType());

			elements.put(IFInputEvent_3021, CakefeedPackage.eINSTANCE
					.getIFInputEvent());

			elements.put(IFOutputEvent_3022, CakefeedPackage.eINSTANCE
					.getIFOutputEvent());

			elements.put(IFInputVar_3023, CakefeedPackage.eINSTANCE
					.getIFInputVar());

			elements.put(IFOutputVar_3024, CakefeedPackage.eINSTANCE
					.getIFOutputVar());

			elements.put(FB_3025, CakefeedPackage.eINSTANCE.getFB());

			elements.put(FBInputEvent_3026, CakefeedPackage.eINSTANCE
					.getFBInputEvent());

			elements.put(FBOutputEvent_3027, CakefeedPackage.eINSTANCE
					.getFBOutputEvent());

			elements.put(FBInputVar_3028, CakefeedPackage.eINSTANCE
					.getFBInputVar());

			elements.put(FBOutputVar_3029, CakefeedPackage.eINSTANCE
					.getFBOutputVar());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(CFBType_2002);
			KNOWN_ELEMENT_TYPES.add(IFInputEvent_3021);
			KNOWN_ELEMENT_TYPES.add(IFOutputEvent_3022);
			KNOWN_ELEMENT_TYPES.add(IFInputVar_3023);
			KNOWN_ELEMENT_TYPES.add(IFOutputVar_3024);
			KNOWN_ELEMENT_TYPES.add(FB_3025);
			KNOWN_ELEMENT_TYPES.add(FBInputEvent_3026);
			KNOWN_ELEMENT_TYPES.add(FBOutputEvent_3027);
			KNOWN_ELEMENT_TYPES.add(FBInputVar_3028);
			KNOWN_ELEMENT_TYPES.add(FBOutputVar_3029);
