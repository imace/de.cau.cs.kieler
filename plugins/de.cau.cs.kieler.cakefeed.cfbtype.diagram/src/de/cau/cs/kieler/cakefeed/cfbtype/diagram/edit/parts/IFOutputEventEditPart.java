...
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.policies.IFOutputEventItemSemanticEditPolicy;
...
import de.cau.cs.kieler.cakefeed.custom.IFOEFigure;

/**
 * @generated
 */
public class IFOutputEventEditPart extends BorderedBorderItemEditPart {
	...
	protected IFigure createNodeShape() {
		primaryShape = new IFOEFigure();

		if (primaryShape instanceof FBTypeFigure) {
			((FBTypeFigure) primaryShape).listenTo(this.getNotationView()
					.getElement());
		}
		return primaryShape;
	}
	 ...
	 * @generated
	 */
	public IFOEFigure getPrimaryShape() {
		return (IFOEFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof IFOutputEventNameEditPart) {
