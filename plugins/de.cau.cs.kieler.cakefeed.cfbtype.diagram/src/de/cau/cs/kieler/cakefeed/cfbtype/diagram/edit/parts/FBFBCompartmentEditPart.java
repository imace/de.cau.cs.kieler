...
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.policies.FBFBCompartmentCanonicalEditPolicy;
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.policies.FBFBCompartmentItemSemanticEditPolicy;
import de.cau.cs.kieler.cakefeed.cfbtype.diagram.part.Messages;

/**
 * @generated
 */
public class FBFBCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public FBFBCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.FBFBCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FBFBCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new FBFBCompartmentCanonicalEditPolicy());
	}
