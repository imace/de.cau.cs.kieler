...
public class InputWithReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		IFInputEvent target = getLink().getParentInputEvent();
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setParentInputEvent(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	 ...
	 * @generated
	 */
	protected IFInputEvent getOldTarget() {
		return (IFInputEvent) oldEnd;
	}
	 ...
	 * @generated
	 */
	protected IFInputEvent getNewTarget() {
		return (IFInputEvent) newEnd;
	}
}
