 ...
 * @generated
 */
public class CFBTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CFBTypeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CakefeedParserProvider
					.getParser(
							CakefeedElementTypes.CFBType_2002,
							getParserElement(),
							CakefeedVisualIDRegistry
									.getType(de.cau.cs.kieler.cakefeed.cfbtype.diagram.edit.parts.CFBTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
