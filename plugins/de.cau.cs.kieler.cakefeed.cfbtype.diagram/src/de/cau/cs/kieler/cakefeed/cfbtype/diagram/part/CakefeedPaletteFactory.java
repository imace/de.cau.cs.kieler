...
public class CakefeedPaletteFactory {
	...
	private ToolEntry createCFBType1CreationTool() {
		...
		entry.setSmallIcon(CakefeedElementTypes
				.getImageDescriptor(CakefeedElementTypes.CFBType_2002));
	...
	private ToolEntry createEvent1CreationTool() {
		...
		entry.setSmallIcon(CakefeedElementTypes
				.getImageDescriptor(CakefeedElementTypes.IFInputEvent_3021));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createVariable2CreationTool() {
		...
		entry.setSmallIcon(CakefeedElementTypes
				.getImageDescriptor(CakefeedElementTypes.IFInputVar_3023));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createFB1CreationTool() {
		...
		entry.setSmallIcon(CakefeedElementTypes
				.getImageDescriptor(CakefeedElementTypes.FB_3025));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
