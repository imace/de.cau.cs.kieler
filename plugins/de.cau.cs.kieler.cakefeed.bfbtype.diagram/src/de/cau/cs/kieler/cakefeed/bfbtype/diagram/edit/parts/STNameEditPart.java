 ...
 * @generated
 */
public class STNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public STNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CakefeedParserProvider
					.getParser(
							CakefeedElementTypes.ST_3035,
							getParserElement(),
							CakefeedVisualIDRegistry
									.getType(de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.parts.STNameEditPart.VISUAL_ID));
		}
		return parser;
	}
