...
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.commands.FBFBDataConnectionCreateCommand;
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.commands.FBFBDataConnectionReorientCommand;
...
public class FBOutputVarItemSemanticEditPolicy extends
	...
	public FBOutputVarItemSemanticEditPolicy() {
		super(CakefeedElementTypes.FBOutputVar_3023);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CakefeedElementTypes.FBFBDataConnection_4005 == req
				.getElementType()) {
