...
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.policies.FBInputEventItemSemanticEditPolicy;
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.part.CakefeedVisualIDRegistry;

/**
 * @generated
 */
public class FBInputEventEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FBInputEventEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FBInputEventItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		FBInputEventFigureDescriptor figure = new FBInputEventFigureDescriptor();
	 ...
	 * @generated
	 */
	public FBInputEventFigureDescriptor getPrimaryShape() {
		return (FBInputEventFigureDescriptor) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FBInputEventNameEditPart) {
			((FBInputEventNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFBIELabel());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class FBInputEventFigureDescriptor extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureFBIELabel;

		/**
		 * @generated
		 */
		public FBInputEventFigureDescriptor() {
		...
		private void createContents() {
			...
			fFigureFBIELabel = new WrappingLabel();
			fFigureFBIELabel.setText("");

			this.add(fFigureFBIELabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFBIELabel() {
			return fFigureFBIELabel;
		}
