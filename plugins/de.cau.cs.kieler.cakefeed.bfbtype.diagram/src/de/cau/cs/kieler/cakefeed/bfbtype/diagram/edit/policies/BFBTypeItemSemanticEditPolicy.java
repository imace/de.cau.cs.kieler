 ...
 * @generated
 */
public class BFBTypeItemSemanticEditPolicy extends
		CakefeedBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public BFBTypeItemSemanticEditPolicy() {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CakefeedElementTypes.IFInputEvent_3024 == req.getElementType()) {
			return getGEFWrapper(new IFInputEventCreateCommand(req));
		}
		if (CakefeedElementTypes.IFOutputEvent_3025 == req.getElementType()) {
			return getGEFWrapper(new IFOutputEventCreateCommand(req));
		}
		if (CakefeedElementTypes.IFInputVar_3026 == req.getElementType()) {
			return getGEFWrapper(new IFInputVarCreateCommand(req));
		}
		if (CakefeedElementTypes.IFOutputVar_3027 == req.getElementType()) {
			return getGEFWrapper(new IFOutputVarCreateCommand(req));
		}
		if (CakefeedElementTypes.InternalVar_3028 == req.getElementType()) {
