...
public class FBItemSemanticEditPolicy extends
	...
	public FBItemSemanticEditPolicy() {
		super(CakefeedElementTypes.FB_3030);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CakefeedElementTypes.FBInputEvent_3031 == req.getElementType()) {
			return getGEFWrapper(new FBInputEventCreateCommand(req));
		}
		if (CakefeedElementTypes.FBOutputEvent_3032 == req.getElementType()) {
			return getGEFWrapper(new FBOutputEventCreateCommand(req));
		}
		if (CakefeedElementTypes.FBInputVar_3033 == req.getElementType()) {
			return getGEFWrapper(new FBInputVarCreateCommand(req));
		}
		if (CakefeedElementTypes.FBOutputVar_3034 == req.getElementType()) {
