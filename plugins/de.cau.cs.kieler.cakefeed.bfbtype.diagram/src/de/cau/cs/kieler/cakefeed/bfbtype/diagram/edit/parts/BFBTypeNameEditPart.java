 ...
 * @generated
 */
public class BFBTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BFBTypeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CakefeedParserProvider
					.getParser(
							CakefeedElementTypes.BFBType_2002,
							getParserElement(),
							CakefeedVisualIDRegistry
									.getType(de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.parts.BFBTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
