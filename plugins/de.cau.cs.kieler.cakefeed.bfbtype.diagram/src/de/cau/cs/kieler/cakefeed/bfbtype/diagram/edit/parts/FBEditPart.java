								...
								for (int i = 0; i < 4; i++) {
									...
									for (EObject o : list) {
										...
										if (o instanceof IFInputEvent) {
											elementType = CakefeedElementTypes.FBInputEvent_3020;
										} else if (o instanceof IFOutputEvent) {
											elementType = CakefeedElementTypes.FBOutputEvent_3021;
										} else if (o instanceof IFInputVar) {
											elementType = CakefeedElementTypes.FBInputVar_3022;
										} else if (o instanceof IFOutputVar) {
											elementType = CakefeedElementTypes.FBOutputVar_3023;
										}
										if ((compartment != null)
												&& (elementType != null)) {
