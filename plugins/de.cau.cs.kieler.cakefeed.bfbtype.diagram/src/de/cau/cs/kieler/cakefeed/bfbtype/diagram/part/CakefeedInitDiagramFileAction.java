 ...
 * @generated
 */
public class CakefeedInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new CakefeedNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				BFBDiagramEditPart.MODEL_ID));
		CakefeedDiagramEditorUtil.runWizard(getShell(), wizard,
