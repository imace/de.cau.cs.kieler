...
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.policies.InternalVarItemSemanticEditPolicy;
import de.cau.cs.kieler.cakefeed.bfbtype.diagram.part.CakefeedVisualIDRegistry;

/**
 * @generated
 */
public class InternalVarEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public InternalVarEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InternalVarItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InternalVarNameEditPart) {
