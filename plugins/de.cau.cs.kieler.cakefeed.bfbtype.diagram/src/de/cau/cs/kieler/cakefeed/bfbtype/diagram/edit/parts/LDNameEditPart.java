 ...
 * @generated
 */
public class LDNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LDNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CakefeedParserProvider
					.getParser(
							CakefeedElementTypes.LD_3036,
							getParserElement(),
							CakefeedVisualIDRegistry
									.getType(de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.parts.LDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
