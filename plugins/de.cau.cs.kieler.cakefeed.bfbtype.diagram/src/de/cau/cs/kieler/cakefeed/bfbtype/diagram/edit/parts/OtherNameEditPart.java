 ...
 * @generated
 */
public class OtherNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OtherNameEditPart(View view) {
		super(view);
	}
			...
			parser = CakefeedParserProvider
					.getParser(
							...
							CakefeedVisualIDRegistry
									.getType(de.cau.cs.kieler.cakefeed.bfbtype.diagram.edit.parts.OtherNameEditPart.VISUAL_ID));
		}
		return parser;
	}
