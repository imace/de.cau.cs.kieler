...
public class AdapterTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdapterType_Comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdapterType_Comment_feature", "_UI_AdapterType_type"),
				 CakefeedPackage.Literals.ADAPTER_TYPE__COMMENT,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdapterType_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdapterType_Name_feature", "_UI_AdapterType_type"),
				 CakefeedPackage.Literals.ADAPTER_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__IDENTIFICATION);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__VERSION_INFO);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__COMPILER_INFO);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__SERVICE);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__INPUT_EVENTS);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__OUTPUT_EVENTS);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__INPUT_VARS);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__OUTPUT_VARS);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__SOCKETS);
			childrenFeatures.add(CakefeedPackage.Literals.ADAPTER_TYPE__PLUGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__IDENTIFICATION,
				 CakefeedFactory.eINSTANCE.createIdentification()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__VERSION_INFO,
				 CakefeedFactory.eINSTANCE.createVersionInfo()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__COMPILER_INFO,
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__INPUT_EVENTS,
				 CakefeedFactory.eINSTANCE.createIFInputEvent()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__OUTPUT_EVENTS,
				 CakefeedFactory.eINSTANCE.createIFOutputEvent()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__INPUT_VARS,
				 CakefeedFactory.eINSTANCE.createIFInputVar()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__OUTPUT_VARS,
				 CakefeedFactory.eINSTANCE.createIFOutputVar()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__SOCKETS,
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.ADAPTER_TYPE__PLUGS,
				 CakefeedFactory.eINSTANCE.createSocket()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == CakefeedPackage.Literals.ADAPTER_TYPE__SOCKETS ||
			childFeature == CakefeedPackage.Literals.ADAPTER_TYPE__PLUGS;
