...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.cakefeed.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.RESOURCE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_Comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_Comment_feature", "_UI_Resource_type"),
				 CakefeedPackage.Literals.RESOURCE__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.RESOURCE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.RESOURCE__PARAMETER);
			childrenFeatures.add(CakefeedPackage.Literals.RESOURCE__FB_NETWORK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.RESOURCE__PARAMETER,
				 CakefeedFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.RESOURCE__FB_NETWORK,
