...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.cakefeed.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_comment_feature", "_UI_Service_type"),
				 CakefeedPackage.Literals.SERVICE__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.SERVICE__RIGHT_INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.SERVICE__LEFT_INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.SERVICE__SERVICE_SEQUENCES);
		}
	...
	public String getText(Object object) {
		String label = ((Service)object).getComment();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Service.class)) {
			...
			case CakefeedPackage.SERVICE__LEFT_INTERFACE:
				...
				return;
			case CakefeedPackage.SERVICE__SERVICE_SEQUENCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.SERVICE__SERVICE_SEQUENCES,
				 CakefeedFactory.eINSTANCE.createServiceSequence()));
	}
