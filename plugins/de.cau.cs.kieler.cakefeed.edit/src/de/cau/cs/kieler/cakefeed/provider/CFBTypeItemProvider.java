...
public class CFBTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.CFB_TYPE__FBS);
			childrenFeatures.add(CakefeedPackage.Literals.CFB_TYPE__EVENT_CONNECTIONS);
			childrenFeatures.add(CakefeedPackage.Literals.CFB_TYPE__DATA_CONNECTIONS);
			childrenFeatures.add(CakefeedPackage.Literals.CFB_TYPE__ADAPTER_CONNECTIONS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.CFB_TYPE__FBS,
				 CakefeedFactory.eINSTANCE.createFB()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.CFB_TYPE__EVENT_CONNECTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.CFB_TYPE__DATA_CONNECTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.CFB_TYPE__ADAPTER_CONNECTIONS,
