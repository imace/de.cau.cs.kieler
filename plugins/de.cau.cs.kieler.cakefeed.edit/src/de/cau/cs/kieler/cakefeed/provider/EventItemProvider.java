...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.cakefeed.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.EVENT__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_Comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_Comment_feature", "_UI_Event_type"),
				 CakefeedPackage.Literals.EVENT__COMMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Event.class)) {
			case CakefeedPackage.EVENT__TYPE:
			case CakefeedPackage.EVENT__COMMENT:
			case CakefeedPackage.EVENT__NAME:
