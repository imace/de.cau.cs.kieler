...
public class SystemItemProvider
	...
	protected void addMappingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_mappings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_mappings_feature", "_UI_System_type"),
				 CakefeedPackage.Literals.SYSTEM__MAPPINGS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSegmentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_segments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_segments_feature", "_UI_System_type"),
				 CakefeedPackage.Literals.SYSTEM__SEGMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_links_feature", "_UI_System_type"),
				 CakefeedPackage.Literals.SYSTEM__LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.SYSTEM__APPLICATIONS);
			childrenFeatures.add(CakefeedPackage.Literals.SYSTEM__DEVICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.SYSTEM__APPLICATIONS,
				 CakefeedFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.SYSTEM__DEVICES,
