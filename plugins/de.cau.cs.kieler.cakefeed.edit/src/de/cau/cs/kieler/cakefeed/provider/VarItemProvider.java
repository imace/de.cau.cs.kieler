...
public class VarItemProvider
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_Comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_Comment_feature", "_UI_Var_type"),
				 CakefeedPackage.Literals.VAR__COMMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.VAR__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Var.class)) {
			...
			case CakefeedPackage.VAR__COMMENT:
			case CakefeedPackage.VAR__NAME:
