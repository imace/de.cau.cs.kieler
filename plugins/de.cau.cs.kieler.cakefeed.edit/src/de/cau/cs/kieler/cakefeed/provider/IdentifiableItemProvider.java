...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.cakefeed.Identifiable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifiableItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.IDENTIFIABLE__IDENTIFICATION);
			childrenFeatures.add(CakefeedPackage.Literals.IDENTIFIABLE__VERSION_INFOS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Identifiable.class)) {
			case CakefeedPackage.IDENTIFIABLE__IDENTIFICATION:
			case CakefeedPackage.IDENTIFIABLE__VERSION_INFOS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.IDENTIFIABLE__IDENTIFICATION,
				 CakefeedFactory.eINSTANCE.createIdentification()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.IDENTIFIABLE__VERSION_INFOS,
