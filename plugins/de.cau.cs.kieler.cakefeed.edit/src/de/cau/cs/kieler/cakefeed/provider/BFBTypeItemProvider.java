...
public class BFBTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.BFB_TYPE__FB_DS);
			childrenFeatures.add(CakefeedPackage.Literals.BFB_TYPE__STS);
			childrenFeatures.add(CakefeedPackage.Literals.BFB_TYPE__LDS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.BFB_TYPE__FB_DS,
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.BFB_TYPE__LDS,
