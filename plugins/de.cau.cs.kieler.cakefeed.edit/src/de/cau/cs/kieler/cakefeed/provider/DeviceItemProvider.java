...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.cakefeed.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.DEVICE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_Comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_Comment_feature", "_UI_Device_type"),
				 CakefeedPackage.Literals.DEVICE__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CakefeedPackage.Literals.DEVICE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.DEVICE__PARAMETER);
			childrenFeatures.add(CakefeedPackage.Literals.DEVICE__RESOURCE);
			childrenFeatures.add(CakefeedPackage.Literals.DEVICE__FB_NETWORK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.DEVICE__PARAMETER,
				 CakefeedFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.DEVICE__RESOURCE,
				 CakefeedFactory.eINSTANCE.createResource()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.DEVICE__FB_NETWORK,
