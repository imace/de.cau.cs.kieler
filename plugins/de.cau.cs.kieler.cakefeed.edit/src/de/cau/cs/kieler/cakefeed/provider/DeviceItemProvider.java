...
public class DeviceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_fBNetwork_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_fBNetwork_feature", "_UI_Device_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CakefeedPackage.Literals.DEVICE__PARAMETERS);
			childrenFeatures.add(CakefeedPackage.Literals.DEVICE__RESOURCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.DEVICE__PARAMETERS,
				 CakefeedFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CakefeedPackage.Literals.DEVICE__RESOURCES,
