...
\usepackage[pdftitle={Configurations and Automated Execution for the KIELER Execution Manager}
, pdfauthor={S\"oren Hansen}, pdfsubject={}]{hyperref}         % Querreferenzen und Links
...
\usepackage{multirow}
\usepackage{natbib}  % Autor-Datum Zitierungen
...
\include{ConfTask}
\include{ConfConcepts}
\include{ConfKiemChanges}
\include{kiemConfig}
\include{ConfConclusion}

\part{Automated Execution}
\include{AutoTechnologies}
\include{AutoTask}
\include{AutoConcepts}
\include{AutoKiemChanges}
\include{kiemAutomated}
\include{AutoConclusion}
