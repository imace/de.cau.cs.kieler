 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.FBDImpl#getFB <em>FB</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.FBDImpl#getDataConnections <em>Data Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FBDImpl extends EObjectImpl implements FBD {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.FBD;
	}
	...
	public EList<FB> getFB() {
		if (fB == null) {
			fB = new EObjectContainmentEList<FB>(FB.class, this, FunctionblocksPackage.FBD__FB);
		}
		return fB;
	}
	...
	public NotificationChain basicSetDataConnections(DataConnections newDataConnections, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.FBD__DATA_CONNECTIONS, oldDataConnections, newDataConnections);
	...
	public void setDataConnections(DataConnections newDataConnections) {
		if (newDataConnections != dataConnections) {
			...
			if (dataConnections != null)
				msgs = ((InternalEObject)dataConnections).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblocksPackage.FBD__DATA_CONNECTIONS, null, msgs);
			if (newDataConnections != null)
				msgs = ((InternalEObject)newDataConnections).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblocksPackage.FBD__DATA_CONNECTIONS, null, msgs);
			msgs = basicSetDataConnections(newDataConnections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.FBD__DATA_CONNECTIONS, newDataConnections, newDataConnections));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.FBD__FB:
				return ((InternalEList<?>)getFB()).basicRemove(otherEnd, msgs);
			case FunctionblocksPackage.FBD__DATA_CONNECTIONS:
