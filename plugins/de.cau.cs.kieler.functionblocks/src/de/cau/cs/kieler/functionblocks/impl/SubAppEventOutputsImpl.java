...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sub App Event Outputs</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.SubAppEventOutputsImpl#getSubAppEvent <em>Sub App Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubAppEventOutputsImpl extends EObjectImpl implements SubAppEventOutputs {
	/**
	 ...
	 * @generated
	 */
	protected SubAppEventOutputsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.SUB_APP_EVENT_OUTPUTS;
	}
	...
	public EList<SubAppEvent> getSubAppEvent() {
		if (subAppEvent == null) {
			subAppEvent = new EObjectContainmentEList<SubAppEvent>(SubAppEvent.class, this, FunctionblocksPackage.SUB_APP_EVENT_OUTPUTS__SUB_APP_EVENT);
		}
		return subAppEvent;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.SUB_APP_EVENT_OUTPUTS__SUB_APP_EVENT:
