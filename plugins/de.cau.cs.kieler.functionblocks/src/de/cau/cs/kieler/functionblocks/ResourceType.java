 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getIdentification <em>Identification</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getVersionInfo <em>Version Info</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getCompilerInfo <em>Compiler Info</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getFBTypeName <em>FB Type Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getVarDeclaration <em>Var Declaration</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getFBNetwork <em>FB Network</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ResourceType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType()
...
public interface ResourceType extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_Identification()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ResourceType#getIdentification <em>Identification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_VersionInfo()
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_CompilerInfo()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ResourceType#getCompilerInfo <em>Compiler Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.cau.cs.kieler.functionblocks.FBTypeName}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_FBTypeName()
	 * @model containment="true"
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_VarDeclaration()
	 * @model containment="true"
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_FBNetwork()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ResourceType#getFBNetwork <em>FB Network</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_Comment()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ResourceType#getComment <em>Comment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getResourceType_Name()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ResourceType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
