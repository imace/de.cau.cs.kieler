 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.OutputPrimitiveImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.OutputPrimitiveImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.OutputPrimitiveImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputPrimitiveImpl extends EObjectImpl implements OutputPrimitive {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.OUTPUT_PRIMITIVE;
	}
	...
	public void setEvent(String newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.OUTPUT_PRIMITIVE__EVENT, oldEvent, event));
	}
	...
	public void setInterface(String newInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.OUTPUT_PRIMITIVE__INTERFACE, oldInterface, interface_));
	}
	...
	public void setParameters(String newParameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.OUTPUT_PRIMITIVE__PARAMETERS, oldParameters, parameters));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblocksPackage.OUTPUT_PRIMITIVE__EVENT:
				return getEvent();
			case FunctionblocksPackage.OUTPUT_PRIMITIVE__INTERFACE:
				return getInterface();
			case FunctionblocksPackage.OUTPUT_PRIMITIVE__PARAMETERS:
