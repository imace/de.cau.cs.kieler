 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBNetwork#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBNetwork#getFB <em>FB</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBNetwork#getEventConnections <em>Event Connections</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBNetwork#getDataConnections <em>Data Connections</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBNetwork#getAdapterConnections <em>Adapter Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork()
...
public interface FBNetwork extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork_Mixed()
	 ...
	 * The list contents are of type {@link de.cau.cs.kieler.functionblocks.FB}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Common element
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork_FB()
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork_EventConnections()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.FBNetwork#getEventConnections <em>Event Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork_DataConnections()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.FBNetwork#getDataConnections <em>Data Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBNetwork_AdapterConnections()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.FBNetwork#getAdapterConnections <em>Adapter Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
