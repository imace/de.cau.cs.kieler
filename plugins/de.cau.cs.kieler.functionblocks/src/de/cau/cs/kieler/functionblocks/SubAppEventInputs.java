 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.SubAppEventInputs#getSubAppEvent <em>Sub App Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppEventInputs()
...
public interface SubAppEventInputs extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppEventInputs_SubAppEvent()
