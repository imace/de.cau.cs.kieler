...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Input Vars</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.InputVarsImpl#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InputVarsImpl extends EObjectImpl implements InputVars {
	/**
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.INPUT_VARS;
	}
	...
	public EList<VarDeclaration> getVarDeclaration() {
		if (varDeclaration == null) {
			varDeclaration = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, FunctionblocksPackage.INPUT_VARS__VAR_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.INPUT_VARS__VAR_DECLARATION:
