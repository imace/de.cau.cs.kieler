...
public class FunctionblocksPackageImpl extends EPackageImpl implements FunctionblocksPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCompiler_Product(), theXMLTypePackage.getString(), "product", null, 1, 1, de.cau.cs.kieler.functionblocks.Compiler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCompiler_Vendor(), theXMLTypePackage.getString(), "vendor", null, 1, 1, de.cau.cs.kieler.functionblocks.Compiler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCompiler_Version(), theXMLTypePackage.getString(), "version", null, 1, 1, de.cau.cs.kieler.functionblocks.Compiler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getECC_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, de.cau.cs.kieler.functionblocks.ECC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFB_Comment(), theXMLTypePackage.getString(), "comment", null, 0, 1, de.cau.cs.kieler.functionblocks.FB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFB_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, de.cau.cs.kieler.functionblocks.FB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFB_Type(), theXMLTypePackage.getString(), "type", null, 1, 1, de.cau.cs.kieler.functionblocks.FB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFB_X(), theXMLTypePackage.getString(), "x", null, 0, 1, de.cau.cs.kieler.functionblocks.FB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFB_Y(), theXMLTypePackage.getString(), "y", null, 0, 1, de.cau.cs.kieler.functionblocks.FB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getST_Text(), theXMLTypePackage.getString(), "text", null, 1, 1, de.cau.cs.kieler.functionblocks.ST.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSystem_Comment(), theXMLTypePackage.getString(), "comment", null, 0, 1, de.cau.cs.kieler.functionblocks.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, de.cau.cs.kieler.functionblocks.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
