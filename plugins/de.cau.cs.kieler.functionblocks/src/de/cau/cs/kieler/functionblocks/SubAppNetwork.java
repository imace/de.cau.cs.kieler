 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getSubApp <em>Sub App</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getFB <em>FB</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getEventConnections <em>Event Connections</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getDataConnections <em>Data Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppNetwork()
...
public interface SubAppNetwork extends EObject {
	 ...
	 * The list contents are of type {@link de.cau.cs.kieler.functionblocks.SubApp}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * SubAppType element
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppNetwork_SubApp()
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppNetwork_FB()
	 * @model containment="true"
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppNetwork_EventConnections()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getEventConnections <em>Event Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getSubAppNetwork_DataConnections()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.SubAppNetwork#getDataConnections <em>Data Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
