 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.OutputVarsImpl#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputVarsImpl extends EObjectImpl implements OutputVars {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.OUTPUT_VARS;
	}
	...
	public EList<VarDeclaration> getVarDeclaration() {
		if (varDeclaration == null) {
			varDeclaration = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, FunctionblocksPackage.OUTPUT_VARS__VAR_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.OUTPUT_VARS__VAR_DECLARATION:
