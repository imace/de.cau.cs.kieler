 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBD#getFB <em>FB</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.FBD#getDataConnections <em>Data Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBD()
...
public interface FBD extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBD_FB()
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getFBD_DataConnections()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.FBD#getDataConnections <em>Data Connections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
