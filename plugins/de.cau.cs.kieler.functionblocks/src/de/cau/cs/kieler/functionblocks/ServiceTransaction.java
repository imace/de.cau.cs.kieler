 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ServiceTransaction#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ServiceTransaction#getInputPrimitive <em>Input Primitive</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.ServiceTransaction#getOutputPrimitive <em>Output Primitive</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getServiceTransaction()
...
public interface ServiceTransaction extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getServiceTransaction_Mixed()
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getServiceTransaction_InputPrimitive()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblocks.ServiceTransaction#getInputPrimitive <em>Input Primitive</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.cau.cs.kieler.functionblocks.OutputPrimitive}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * FBType element
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getServiceTransaction_OutputPrimitive()
	 * @model containment="true" transient="true" volatile="true" derived="true"
