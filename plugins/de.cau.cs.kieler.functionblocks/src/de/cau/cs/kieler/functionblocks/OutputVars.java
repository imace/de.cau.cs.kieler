 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.OutputVars#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getOutputVars()
...
public interface OutputVars extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblocks.FunctionblocksPackage#getOutputVars_VarDeclaration()
