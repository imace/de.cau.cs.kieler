 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.LinkImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.LinkImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.LinkImpl#getCommResource <em>Comm Resource</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.LinkImpl#getSegmentName <em>Segment Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkImpl extends EObjectImpl implements Link {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.LINK;
	}
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, FunctionblocksPackage.LINK__PARAMETER);
		}
		return parameter;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.LINK__COMMENT, oldComment, comment));
	}
	...
	public void setCommResource(String newCommResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.LINK__COMM_RESOURCE, oldCommResource, commResource));
	}
	...
	public void setSegmentName(String newSegmentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.LINK__SEGMENT_NAME, oldSegmentName, segmentName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.LINK__PARAMETER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblocksPackage.LINK__PARAMETER:
				return getParameter();
			case FunctionblocksPackage.LINK__COMMENT:
				return getComment();
			case FunctionblocksPackage.LINK__COMM_RESOURCE:
				return getCommResource();
			case FunctionblocksPackage.LINK__SEGMENT_NAME:
