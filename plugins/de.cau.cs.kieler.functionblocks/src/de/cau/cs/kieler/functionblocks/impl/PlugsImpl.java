 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.PlugsImpl#getAdapterDeclaration <em>Adapter Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlugsImpl extends EObjectImpl implements Plugs {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.PLUGS;
	}
	...
	public EList<AdapterDeclaration> getAdapterDeclaration() {
		if (adapterDeclaration == null) {
			adapterDeclaration = new EObjectContainmentEList<AdapterDeclaration>(AdapterDeclaration.class, this, FunctionblocksPackage.PLUGS__ADAPTER_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblocksPackage.PLUGS__ADAPTER_DECLARATION:
