 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.InputPrimitiveImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.InputPrimitiveImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.InputPrimitiveImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputPrimitiveImpl extends EObjectImpl implements InputPrimitive {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.INPUT_PRIMITIVE;
	}
	...
	public void setEvent(String newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.INPUT_PRIMITIVE__EVENT, oldEvent, event));
	}
	...
	public void setInterface(String newInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.INPUT_PRIMITIVE__INTERFACE, oldInterface, interface_));
	}
	...
	public void setParameters(String newParameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.INPUT_PRIMITIVE__PARAMETERS, oldParameters, parameters));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblocksPackage.INPUT_PRIMITIVE__EVENT:
				return getEvent();
			case FunctionblocksPackage.INPUT_PRIMITIVE__INTERFACE:
				return getInterface();
			case FunctionblocksPackage.INPUT_PRIMITIVE__PARAMETERS:
