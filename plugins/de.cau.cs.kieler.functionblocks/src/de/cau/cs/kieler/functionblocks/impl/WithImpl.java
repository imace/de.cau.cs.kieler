 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblocks.impl.WithImpl#getVar <em>Var</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WithImpl extends EObjectImpl implements With {
	...
	protected EClass eStaticClass() {
		return FunctionblocksPackage.Literals.WITH;
	}
	...
	public void setVar(String newVar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblocksPackage.WITH__VAR, oldVar, var));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblocksPackage.WITH__VAR:
				return getVar();
		}
