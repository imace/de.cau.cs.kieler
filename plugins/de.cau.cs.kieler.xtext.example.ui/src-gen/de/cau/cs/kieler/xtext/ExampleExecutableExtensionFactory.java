 ...
 * generated
 */
public class ExampleExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(ExampleExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.xtext.internal.ExampleActivator instance = de.cau.cs.kieler.xtext.internal.ExampleActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.xtext.internal.ExampleActivator.getInstance().getInjector("de.cau.cs.kieler.xtext.Example");
