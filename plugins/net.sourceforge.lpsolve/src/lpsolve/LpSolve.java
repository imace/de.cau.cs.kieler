...
/**
 * Object wrapper for a problem structure of the lp_solve library. Offers access to all lp_solve
 * methods.
 * 
...
public class LpSolve {
    ...
    /**
     * Creates a new problem. Upon successful completion, the lprec attribute in this class contains
     * the value of the pointer to the <code>lprec</code> structure.
     * 
     * @param rows
     ...
     *             if lp_solve could not create the problem
     */
     ...
     */
    public static native LpSolve readMps(String filename, int verbose) throws LpSolveException;

    /**
     * Read a model in free MPS format from file and create a new problem.
     */
    public static native LpSolve readFreeMps(String filename, int verbose) throws LpSolveException;

    /**
     * Read a model via the External Language Interface and create a new problem.
     */
    public static native LpSolve readXLI(String xliname, String modelname, String dataname,
            String options, int verbose) throws LpSolveException;
    ...
    /**
     * Copy an existing lprec structure to a new lprec structure. Creates an independent new
     * problem.
     */
     ...
     * Add a constraint to the problem.
     */
    public native void addConstraintex(int count, double[] row, int[] colno, int constrType, double rh)
            throws LpSolveException;
     ...
     * Set a column in the lp.
     */
    public native void setColumnex(int colno, int count, double[] column, int[] rowno)
            throws LpSolveException;
    ...
    /**
     * Get the value of the right hand side (RHS) vector (column 0) for one row. NOTE: Returns 0
     * even if the row index is out of bounds, in accordance to the behaviour of the lp_solve
     * routine!
     */
     ...
     */
    public native void addSOS(String name, int sostype, int priority, int count, int[] sosvars,
            double[] weights) throws LpSolveException;
    ...
    /**
     * Get all row elements from the matrix. Passed in arrays must be allocated by the caller of the
     * method.
     */
    public native void getRow(int rownr, double[] row) throws LpSolveException;

    /**
     * Get the non-zero row elements from the matrix. Passed in arrays must be allocated by the
     * caller of the method.
     */
    public native int getRowex(int rownr, double[] row, int[] nzcols) throws LpSolveException;

    /**
     * Get all row elements from the matrix. Returned array is allocated by the method. This is an
     * additional method which is not implemented by lp_solve. Internally, get_row is used.
     */
    public native double[] getPtrRow(int rownr) throws LpSolveException;

    /**
     * Get all column elements from the matrix. Passed in arrays must be allocated by the caller of
     * the method.
     */
    public native void getColumn(int colnr, double[] column) throws LpSolveException;

    /**
     * Get the non-zero column elements from the matrix. Passed in arrays must be allocated by the
     * caller of the method.
     */
    public native int getColumnex(int colnr, double[] column, int[] nzrows) throws LpSolveException;

    /**
     * Get all column elements from the matrix. Returned array is allocated by the method. This is
     * an additional method which is not implemented by lp_solve. Internally, get_column is used.
     */
    ...
    /**
     * Specifies the tolerance that is used to determine whether a floating-point number is in fact
     * an integer.
     */
    public native void setEpsint(double value);

    /**
     * Returns the tolerance that is used to determine whether a floating-point number is in fact an
     * integer
     */
    public native double getEpsint();

    /**
     * Specifies the value that is used as a tolerance for the Right Hand Side (RHS) to determine
     * whether a value should be considered as 0
     */
    public native void setEpsb(double value);

    /**
     * Returns the value that is used as a tolerance for the Right Hand Side (RHS) to determine
     * whether a value should be considered as 0.
     */
    public native double getEpsb();

    /**
     * Specifies the value that is used as a tolerance for reduced costs to determine whether a
     * value should be considered as 0.
     */
    public native void setEpsd(double value);

    /**
     * Returns the value that is used as a tolerance for the reduced costs to determine whether a
     * value should be considered as 0.
     */
    ...
    /**
     * Specifies the value that is used as a tolerance pivot element to determine whether a value
     * should be considered as 0.
     */
    public native void setEpspivot(double value);

    /**
     * Returns the value that is used as a tolerance pivot element to determine whether a value
     * should be considered as 0.
     */
    ...
    /**
     * This is a simplified way of specifying multiple eps thresholds that are "logically"
     * consistent.
     */
    ...
    /**
     * Sets a flag if all intermediate results and the branch-and-bound decisions must be printed
     * while solving.
     */
    public native void setDebug(boolean debug);

    /**
     * Returns a flag if all intermediate results and the branch-and-bound decisions must be printed
     * while solving.
     */
    ...
    /**
     * Specifies, for the specified variable, which branch to take first in branch-and-bound
     * algorithm.
     */
    public native void setVarBranch(int colnr, int branchMode) throws LpSolveException;

    /**
     * Returns, for the specified variable, which branch to take first in branch-and-bound
     * algorithm.
     */
    ...
    /**
     * Returns, for the specified variable, the priority the variable has in the branch-and-bound
     * algorithm.
     */
    ...
    /**
     * Specifies if the branch-and-bound algorithm stops when the object value is better than a
     * given value.
     */
    public native void setBreakAtValue(double breakAtValue);

    /**
     * Returns the value at which the branch-and-bound algorithm stops when the object value is
    ...
    /**
     * Sets the relative scaling convergence criterion for the active scaling mode; the integer part
     * specifies the maximum number of iterations.
     */
    public native void setScalelimit(double scalelimit);

    /**
     * Returns the relative scaling convergence criterion for the active scaling mode; the integer
     * part specifies the maximum number of iterations.
     */
    ...
    /**
     * Returns the negative value below which variables are split into a negative and a positive
     * part.
     */
    ...
    /**
     * Returns if the native (build-in) basis factorization package (BFP) is used, or an external
     * package.
     */
    ...
    */
    ...
    /**
     * Returns the values of the variables. Passed in arrays must be allocated by the caller of the
     * method.
     */
    ...
    /**
     * Returns the values of the constraints. Passed in arrays must be allocated by the caller of
     * the method.
     */
    ...
    /**
     * Returns the solution of the model. Passed in arrays must be allocated by the caller of the
     * method.
     */
    ...
    /**
     * Returns the sensitivity of the constraints and the variables. Passed in arrays must be
     * allocated by the caller of the method.
     */
    public native void getSensitivityRhs(double[] duals, double[] dualsfrom, double[] dualstill)
            throws LpSolveException;

    /**
     * Returns the sensitivity of the constraints and the variables. Returned arrays are allocated
     * by the method. The returned array contains two elements of type double[]. element [0] is the
     * duals array, element [1] is the dualsfrom array, element [2] is the dualstill array.
     */
    ...
    /**
     * Returns the sensitivity of the constraints and the variables. Returned array is allocated by
     * the method.
     */
    ...
    /**
     * Returns the sensitivity of the objective function. Passed in arrays must be allocated by the
     * caller of the method.
     */
    public native void getSensitivityObj(double[] objfrom, double[] objtill) throws LpSolveException;

    /**
     * Returns the sensitivity of the objective function. Returned arrays are allocated by the
     * method. The returned array contains two elements of type double[]. element [0] is the objfrom
     * array, element [1] is the objtill array.
     */
     ...
     * caller of the method.
     */
    public native void getSensitivityObjex(double[] objfrom, double[] objtill, double[] objfromvalue,
            double[] objtillvalue) throws LpSolveException;

    /**
     * Returns the sensitivity of the objective function. Returned arrays are allocated by the
     * method. The returned array contains four elements of type double[]. element [0] is the
     * objfrom array, element [1] is the objtill array, element [2] is the objfromvalue array,
     * element [3] is the objtillvalue array.
     */
    public native double[][] getPtrSensitivityObjex() throws LpSolveException;

    /**
     * Returns the Lamdba vectors (Lagrangian optimization). Passed in array must be allocated by
     * the caller of the method.
     */
    public native void getLambda(double[] lambda) throws LpSolveException;

    /**
     * Returns the Lamdba vectors (Lagrangian optimization). Returned array is allocated by the
     * method.
     */
    ...
    /**
     * Prints the lp model. This function is meant for debugging purposes. By default, the output is
     * stdout. However this can be changed via a call to setOutputfile.
     */
    public native void printLp();

    /**
     * Prints the values of the constraints of the lp. This can only be done after a successful
     * solve. This function is meant for debugging purposes. By default, the output is stdout.
     * However this can be changed via a call to setOutputfile.
     */
    public native void printConstraints(int columns);

    /**
     * Prints the values of the duals of the lp. This can only be done after a successful solve.
     * This function is meant for debugging purposes. By default, the output is stdout. However this
     * can be changed via a call to setOutputfile.
     */
    public native void printDuals();

    /**
     * Prints the scales of the lp. This can only be done after a successful solve. This function is
     * meant for debugging purposes. By default, the output is stdout. However this can be changed
     * via a call to setOutputfile.
     */
    public native void printScales();

    /**
     * Prints the tableau. This can only be done after a successful solve. This function is meant
     * for debugging purposes. By default, the output is stdout. However this can be changed via a
     * call to setOutputfile.
     */
    public native void printTableau();

    /**
     * Prints the objective value of the lp. This can only be done after a successful solve. This
     * function is meant for debugging purposes. By default, the output is stdout. However this can
     * be changed via a call to setOutputfile.
     */
    public native void printObjective();

    /**
     * Prints the solution (variables) of the lp. This can only be done after a successful solve.
     * This function is meant for debugging purposes. By default, the output is stdout. However this
     * can be changed via a call to setOutputfile.
     */
    ...
    /**
     * Do a generic readable data dump of key lp_solve model variables; principally for run
     * difference and debugging purposes.
     */
     ...
     */
    public native void writeXLI(String filename, String options, boolean results)
            throws LpSolveException;
    ...
    /**
     * Gets the index of a given column or row name in the lp. A return value of -1 indicates that
    ...
    /**
     * This is an internal function that has been published for special purposes. It should
     ...
     * 
     * @param listener
     *            the listener that should be called by lp_solve
     * @param userhandle
