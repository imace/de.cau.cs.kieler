...
public class LayoutEffect extends AEffect {
     ...
     * it changes the notation model and hence must go through the EMF
     * transaction mechanism. When this execute is called from a weird thread,
     * e.g. when the notation model is in a read-only context, you might
     * otherwise get an IllegalStateException. So here layout is called from
