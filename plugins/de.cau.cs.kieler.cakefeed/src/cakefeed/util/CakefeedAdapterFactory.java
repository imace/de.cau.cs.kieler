...
public class CakefeedAdapterFactory extends AdapterFactoryImpl {
	...
	protected CakefeedSwitch<Adapter> modelSwitch =
		new CakefeedSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExecutionControlChart(ExecutionControlChart object) {
				return createExecutionControlChartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link cakefeed.ExecutionControlChart <em>Execution Control Chart</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExecutionControlChartAdapter() {
		return null;
	}
