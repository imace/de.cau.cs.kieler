 ...
 *   <li>{@link cakefeed.impl.EventConnectionImpl#getAssociations <em>Associations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventConnectionImpl extends ConnectionImpl implements EventConnection {
	...
	public EList<Association> getAssociations() {
		if (associations == null) {
			associations = new EObjectContainmentWithInverseEList<Association>(Association.class, this, CakefeedPackage.EVENT_CONNECTION__ASSOCIATIONS, CakefeedPackage.ASSOCIATION__PARENT_EVENT_CONNECTION);
		}
		return associations;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CakefeedPackage.EVENT_CONNECTION__ASSOCIATIONS:
