		...
		if (compositeNetwork != null && compositeNetwork.eIsProxy()) {
			...
			if (compositeNetwork != oldCompositeNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CakefeedPackage.COMPOSITE_FUNCTION_BLOCK_INSTANCE__COMPOSITE_NETWORK, oldCompositeNetwork, compositeNetwork));
			}
		}
