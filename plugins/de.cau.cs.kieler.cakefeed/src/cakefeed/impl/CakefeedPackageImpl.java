...
public class CakefeedPackageImpl extends EPackageImpl implements CakefeedPackage {
	 ...
	 * @generated
	 */
	private EClass executionControlChartEClass = null;
	 ...
	 * @generated
	 */
	public EReference getFunctionBlock_ParentLibrary() {
	 ...
	 * @generated
	 */
	public EReference getEventConnection_Associations() {
		return (EReference)eventConnectionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getDataConnection_Associations() {
	 ...
	 * @generated
	 */
	public EReference getAlgorithm_ParentLibrary() {
	 ...
	 * @generated
	 */
	public EClass getExecutionControlChart() {
		return executionControlChartEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getExecutionControlChart_ParentBasicFunctionBlock() {
		return (EReference)executionControlChartEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getServiceSequence_ParentLibrary() {
	 ...
	 * @generated
	 */
	public EReference getLibrary_FunctionBlocks() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_ParentEventConnection() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_AssociatedDataConnection() {
	...
	public void createPackageContents() {
		...
		createEReference(functionBlockEClass, FUNCTION_BLOCK__PARENT_LIBRARY);
		...
		createEReference(eventConnectionEClass, EVENT_CONNECTION__ASSOCIATIONS);
		...
		createEReference(dataConnectionEClass, DATA_CONNECTION__ASSOCIATIONS);
		...
		createEReference(algorithmEClass, ALGORITHM__PARENT_LIBRARY);
		...
		executionControlChartEClass = createEClass(EXECUTION_CONTROL_CHART);
		createEReference(executionControlChartEClass, EXECUTION_CONTROL_CHART__PARENT_BASIC_FUNCTION_BLOCK);
		...
		createEReference(serviceSequenceEClass, SERVICE_SEQUENCE__PARENT_LIBRARY);

		libraryEClass = createEClass(LIBRARY);
		createEReference(libraryEClass, LIBRARY__FUNCTION_BLOCKS);
		createEReference(libraryEClass, LIBRARY__ALGORITHMS);
		createEReference(libraryEClass, LIBRARY__SERVICE_SEQUENCES);

		associationEClass = createEClass(ASSOCIATION);
		createEReference(associationEClass, ASSOCIATION__PARENT_EVENT_CONNECTION);
		createEReference(associationEClass, ASSOCIATION__ASSOCIATED_DATA_CONNECTION);
	...
	public void initializePackageContents() {
		...
		initEReference(getFunctionBlock_ParentLibrary(), this.getLibrary(), this.getLibrary_FunctionBlocks(), "parentLibrary", null, 1, 1, FunctionBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBasicFunctionBlock_ExecutionControlChart(), this.getExecutionControlChart(), this.getExecutionControlChart_ParentBasicFunctionBlock(), "executionControlChart", null, 0, 1, BasicFunctionBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEventConnection_Associations(), this.getAssociation(), this.getAssociation_ParentEventConnection(), "associations", null, 0, -1, EventConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDataConnection_Associations(), this.getAssociation(), this.getAssociation_AssociatedDataConnection(), "associations", null, 0, -1, DataConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAlgorithm_ParentLibrary(), this.getLibrary(), this.getLibrary_Algorithms(), "parentLibrary", null, 1, 1, Algorithm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(executionControlChartEClass, ExecutionControlChart.class, "ExecutionControlChart", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExecutionControlChart_ParentBasicFunctionBlock(), this.getBasicFunctionBlock(), this.getBasicFunctionBlock_ExecutionControlChart(), "parentBasicFunctionBlock", null, 1, 1, ExecutionControlChart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getServiceSequence_ParentLibrary(), this.getLibrary(), this.getLibrary_ServiceSequences(), "parentLibrary", null, 1, 1, ServiceSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(libraryEClass, Library.class, "Library", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLibrary_FunctionBlocks(), this.getFunctionBlock(), this.getFunctionBlock_ParentLibrary(), "functionBlocks", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLibrary_Algorithms(), this.getAlgorithm(), this.getAlgorithm_ParentLibrary(), "algorithms", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLibrary_ServiceSequences(), this.getServiceSequence(), this.getServiceSequence_ParentLibrary(), "serviceSequences", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAssociation_ParentEventConnection(), this.getEventConnection(), this.getEventConnection_Associations(), "parentEventConnection", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_AssociatedDataConnection(), this.getDataConnection(), this.getDataConnection_Associations(), "associatedDataConnection", null, 1, -1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
