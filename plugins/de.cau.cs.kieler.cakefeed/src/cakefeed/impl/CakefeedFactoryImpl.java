...
public class CakefeedFactoryImpl extends EFactoryImpl implements CakefeedFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CakefeedPackage.EXECUTION_CONTROL_CHART: return createExecutionControlChart();
	 ...
	 * @generated
	 */
	public ExecutionControlChart createExecutionControlChart() {
		ExecutionControlChartImpl executionControlChart = new ExecutionControlChartImpl();
