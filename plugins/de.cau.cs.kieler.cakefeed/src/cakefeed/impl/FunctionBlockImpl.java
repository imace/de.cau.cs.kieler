 ...
 *   <li>{@link cakefeed.impl.FunctionBlockImpl#getParentLibrary <em>Parent Library</em>}</li>
...
public abstract class FunctionBlockImpl extends EObjectImpl implements FunctionBlock {
	...
	public Library getParentLibrary() {
		if (eContainerFeatureID() != CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY) return null;
	...
	public NotificationChain basicSetParentLibrary(Library newParentLibrary, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParentLibrary, CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY, msgs);
		return msgs;
	}
	...
	public void setParentLibrary(Library newParentLibrary) {
		if (newParentLibrary != eInternalContainer() || (eContainerFeatureID() != CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY && newParentLibrary != null)) {
			...
			if (newParentLibrary != null)
				msgs = ((InternalEObject)newParentLibrary).eInverseAdd(this, CakefeedPackage.LIBRARY__FUNCTION_BLOCKS, Library.class, msgs);
			msgs = basicSetParentLibrary(newParentLibrary, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY, newParentLibrary, newParentLibrary));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case CakefeedPackage.FUNCTION_BLOCK__PARENT_LIBRARY:
				return eInternalContainer().eInverseRemove(this, CakefeedPackage.LIBRARY__FUNCTION_BLOCKS, Library.class, msgs);
		}
