 ...
 * <ul>
 *   <li>{@link cakefeed.Algorithm#getParentLibrary <em>Parent Library</em>}</li>
...
public interface Algorithm extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link cakefeed.Library#getAlgorithms <em>Algorithms</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see cakefeed.CakefeedPackage#getAlgorithm_ParentLibrary()
	 * @see cakefeed.Library#getAlgorithms
	 * @model opposite="algorithms" required="true" transient="false"
	 * @generated
	 */
	Library getParentLibrary();

	/**
	 * Sets the value of the '{@link cakefeed.Algorithm#getParentLibrary <em>Parent Library</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
