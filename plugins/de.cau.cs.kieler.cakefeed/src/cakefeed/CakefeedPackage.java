...
public interface CakefeedPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int FUNCTION_BLOCK__TYPE_NAME = 0;

	/**
	 * The feature id for the '<em><b>Parent Library</b></em>' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNCTION_BLOCK__PARENT_LIBRARY = 1;
	 ...
	 * @ordered
	 */
	int BASIC_FUNCTION_BLOCK__PARENT_LIBRARY = FUNCTION_BLOCK__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int COMPOSITE_FUNCTION_BLOCK__PARENT_LIBRARY = FUNCTION_BLOCK__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int SERVICE_INTERFACE_FUNCTION_BLOCK__PARENT_LIBRARY = FUNCTION_BLOCK__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY = FUNCTION_BLOCK__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int BASIC_FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY = FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int BASIC_FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT = FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int COMPOSITE_FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY = FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int COMPOSITE_FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT = FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SERVICE_INTERFACE_FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY = FUNCTION_BLOCK_INSTANCE__PARENT_LIBRARY;
	 ...
	 * @ordered
	 */
	int SERVICE_INTERFACE_FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT = FUNCTION_BLOCK_INSTANCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int INPUT_EVENT_PORT_FEATURE_COUNT = EVENT_PORT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int OUTPUT_EVENT_PORT_FEATURE_COUNT = EVENT_PORT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int INPUT_DATA_PORT_FEATURE_COUNT = DATA_PORT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int OUTPUT_DATA_PORT_FEATURE_COUNT = DATA_PORT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ALGORITHM__PARENT_LIBRARY = 0;
	 ...
	 * @ordered
	 */
	int ALGORITHM__ALGORITHM_NAME = 1;
	 ...
	 * @ordered
	 */
	int ALGORITHM__ALGORITHM_LANGUAGE = 2;
	 ...
	 * @ordered
	 */
	int ALGORITHM__ALGORITHM_SOURCE_CODE = 3;
	...
	/**
	 * The meta object id for the '{@link cakefeed.impl.ExecutionControlChartImpl <em>Execution Control Chart</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see cakefeed.impl.ExecutionControlChartImpl
	 * @see cakefeed.impl.CakefeedPackageImpl#getExecutionControlChart()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int EXECUTION_CONTROL_CHART__PARENT_BASIC_FUNCTION_BLOCK = 0;

	/**
	 * The number of structural features of the '<em>Execution Control Chart</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EXECUTION_CONTROL_CHART_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int SERVICE_SEQUENCE__PARENT_LIBRARY = 0;
	 ...
	 * @ordered
	 */
	int SERVICE_SEQUENCE_FEATURE_COUNT = 1;
	...
	/**
	 * The feature id for the '<em><b>Function Blocks</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LIBRARY__FUNCTION_BLOCKS = 0;
	 ...
	 * @ordered
	 */
	int LIBRARY__SERVICE_SEQUENCES = 2;
	...
	/**
	 * Returns the meta object for the container reference '{@link cakefeed.FunctionBlock#getParentLibrary <em>Parent Library</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Parent Library</em>'.
	 * @see cakefeed.FunctionBlock#getParentLibrary()
	 * @see #getFunctionBlock()
	 * @generated
	 */
	EReference getFunctionBlock_ParentLibrary();
	...
	/**
	 * Returns the meta object for the container reference '{@link cakefeed.Algorithm#getParentLibrary <em>Parent Library</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Parent Library</em>'.
	 ...
	 * @generated
	 */
	EReference getAlgorithm_ParentLibrary();
	...
	/**
	 * Returns the meta object for class '{@link cakefeed.ExecutionControlChart <em>Execution Control Chart</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Execution Control Chart</em>'.
	 * @see cakefeed.ExecutionControlChart
	 * @generated
	 */
	 ...
	 * @generated
	 */
	EReference getExecutionControlChart_ParentBasicFunctionBlock();
	...
	/**
	 * Returns the meta object for the container reference '{@link cakefeed.ServiceSequence#getParentLibrary <em>Parent Library</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Parent Library</em>'.
	 ...
	 * @generated
	 */
	EReference getServiceSequence_ParentLibrary();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link cakefeed.Library#getFunctionBlocks <em>Function Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Function Blocks</em>'.
	 * @see cakefeed.Library#getFunctionBlocks()
	 * @see #getLibrary()
	 * @generated
	 */
	EReference getLibrary_FunctionBlocks();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link cakefeed.Library#getServiceSequences <em>Service Sequences</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Parent Library</b></em>' container reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FUNCTION_BLOCK__PARENT_LIBRARY = eINSTANCE.getFunctionBlock_ParentLibrary();
		 ...
		 * @generated
		 */
		EReference ALGORITHM__PARENT_LIBRARY = eINSTANCE.getAlgorithm_ParentLibrary();
		...
		/**
		 * The meta object literal for the '{@link cakefeed.impl.ExecutionControlChartImpl <em>Execution Control Chart</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see cakefeed.impl.ExecutionControlChartImpl
		 * @see cakefeed.impl.CakefeedPackageImpl#getExecutionControlChart()
		 ...
		 * @generated
		 */
		EReference EXECUTION_CONTROL_CHART__PARENT_BASIC_FUNCTION_BLOCK = eINSTANCE.getExecutionControlChart_ParentBasicFunctionBlock();
		 ...
		 * @generated
		 */
		EReference SERVICE_SEQUENCE__PARENT_LIBRARY = eINSTANCE.getServiceSequence_ParentLibrary();
		...
		/**
		 * The meta object literal for the '<em><b>Function Blocks</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference LIBRARY__FUNCTION_BLOCKS = eINSTANCE.getLibrary_FunctionBlocks();
