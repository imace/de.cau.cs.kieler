 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.Service#getServiceSequence <em>Service Sequence</em>}</li>
...
public interface Service extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Service Sequence</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Service Sequence</em>' containment reference list.
	 * @see de.cau.cs.kieler.cakefeed.CakefeedPackage#getService_ServiceSequence()
