 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ServiceImpl#getServiceSequences <em>Service Sequences</em>}</li>
...
public class ServiceImpl extends EObjectImpl implements Service {
	...
	public EList<ServiceSequence> getServiceSequences() {
		if (serviceSequences == null) {
			serviceSequences = new EObjectContainmentEList<ServiceSequence>(ServiceSequence.class, this, CakefeedPackage.SERVICE__SERVICE_SEQUENCES);
		}
