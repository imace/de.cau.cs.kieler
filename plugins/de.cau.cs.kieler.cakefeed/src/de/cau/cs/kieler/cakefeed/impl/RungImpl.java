...
public class RungImpl extends EObjectImpl implements Rung {
	 ...
	 * @generated
	 */
	public OutputEvent getOutput() {
		if (output != null && output.eIsProxy()) {
			InternalEObject oldOutput = (InternalEObject)output;
			output = (OutputEvent)eResolveProxy(oldOutput);
			if (output != oldOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CakefeedPackage.RUNG__OUTPUT, oldOutput, output));
			}
		}
		return output;
	}
	 ...
	 * @generated
	 */
	public OutputEvent basicGetOutput() {
		return output;
	}
	 ...
	 * @generated
	 */
	public void setOutput(OutputEvent newOutput) {
		OutputEvent oldOutput = output;
		output = newOutput;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CakefeedPackage.RUNG__EXPRESSION:
				...
				return;
			case CakefeedPackage.RUNG__OUTPUT:
				setOutput((OutputEvent)newValue);
				return;
		}
