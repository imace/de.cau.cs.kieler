 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.CFBTypeImpl#getFBNetwork <em>FB Network</em>}</li>
...
public class CFBTypeImpl extends FBTypeImpl implements CFBType {
	...
	public NotificationChain basicSetFBNetwork(FBNetwork newFBNetwork, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CakefeedPackage.CFB_TYPE__FB_NETWORK, oldFBNetwork, newFBNetwork);
	...
	public void setFBNetwork(FBNetwork newFBNetwork) {
		if (newFBNetwork != fbNetwork) {
			...
			if (fbNetwork != null)
				msgs = ((InternalEObject)fbNetwork).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CakefeedPackage.CFB_TYPE__FB_NETWORK, null, msgs);
			if (newFBNetwork != null)
				msgs = ((InternalEObject)newFBNetwork).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CakefeedPackage.CFB_TYPE__FB_NETWORK, null, msgs);
			msgs = basicSetFBNetwork(newFBNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.CFB_TYPE__FB_NETWORK, newFBNetwork, newFBNetwork));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CakefeedPackage.CFB_TYPE__FB_NETWORK:
