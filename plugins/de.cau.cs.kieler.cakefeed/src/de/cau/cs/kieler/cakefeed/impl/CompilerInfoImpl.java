 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.CompilerInfoImpl#getCompiler <em>Compiler</em>}</li>
...
public class CompilerInfoImpl extends EObjectImpl implements CompilerInfo {
	 ...
	 * @ordered
	 */
	protected EList<de.cau.cs.kieler.cakefeed.Compiler> compiler;
	 ...
	 * @generated
	 */
	public EList<de.cau.cs.kieler.cakefeed.Compiler> getCompiler() {
		if (compiler == null) {
			compiler = new EObjectContainmentEList<de.cau.cs.kieler.cakefeed.Compiler>(de.cau.cs.kieler.cakefeed.Compiler.class, this, CakefeedPackage.COMPILER_INFO__COMPILER);
		}
		return compiler;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CakefeedPackage.COMPILER_INFO__COMPILER:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CakefeedPackage.COMPILER_INFO__COMPILER:
				getCompiler().clear();
				getCompiler().addAll((Collection<? extends de.cau.cs.kieler.cakefeed.Compiler>)newValue);
				return;
			case CakefeedPackage.COMPILER_INFO__CLASSDEF:
