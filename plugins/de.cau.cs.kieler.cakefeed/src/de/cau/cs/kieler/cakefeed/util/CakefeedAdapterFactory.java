...
public class CakefeedAdapterFactory extends AdapterFactoryImpl {
	...
	protected CakefeedSwitch<Adapter> modelSwitch =
		new CakefeedSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFBInterface(FBInterface object) {
				return createFBInterfaceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.cakefeed.FBInterface <em>FB Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
