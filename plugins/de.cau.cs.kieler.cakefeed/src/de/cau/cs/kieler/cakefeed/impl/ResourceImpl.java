 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ResourceImpl#getParameter <em>Parameter</em>}</li>
 ...
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ResourceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ResourceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends EObjectImpl implements Resource {
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, CakefeedPackage.RESOURCE__PARAMETER);
		}
		return parameter;
	}
	...
	public NotificationChain basicSetFBNetwork(FBNetwork newFBNetwork, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CakefeedPackage.RESOURCE__FB_NETWORK, oldFBNetwork, newFBNetwork);
	...
	public void setFBNetwork(FBNetwork newFBNetwork) {
		if (newFBNetwork != fbNetwork) {
			...
			if (fbNetwork != null)
				msgs = ((InternalEObject)fbNetwork).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CakefeedPackage.RESOURCE__FB_NETWORK, null, msgs);
			if (newFBNetwork != null)
				msgs = ((InternalEObject)newFBNetwork).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CakefeedPackage.RESOURCE__FB_NETWORK, null, msgs);
			msgs = basicSetFBNetwork(newFBNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.RESOURCE__FB_NETWORK, newFBNetwork, newFBNetwork));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.RESOURCE__COMMENT, oldComment, comment));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.RESOURCE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CakefeedPackage.RESOURCE__PARAMETER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CakefeedPackage.RESOURCE__TYPE:
				...
				return basicGetType();
			case CakefeedPackage.RESOURCE__COMMENT:
				return getComment();
			case CakefeedPackage.RESOURCE__NAME:
				return getName();
		}
