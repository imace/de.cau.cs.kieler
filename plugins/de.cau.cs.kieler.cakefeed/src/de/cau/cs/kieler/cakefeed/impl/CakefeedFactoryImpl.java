...
public class CakefeedFactoryImpl extends EFactoryImpl implements CakefeedFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CakefeedPackage.FUNCTION_BLOCK_NETWORK: return createFunctionBlockNetwork();
			...
			case CakefeedPackage.FUNCTION_BLOCK: return createFunctionBlock();
			case CakefeedPackage.FUNCTION_BLOCK_INTERFACE: return createFunctionBlockInterface();
			...
			case CakefeedPackage.BASIC_FUNCTION_BLOCK_TYPE: return createBasicFunctionBlockType();
			case CakefeedPackage.FUNCTION_BLOCK_DIAGRAM: return createFunctionBlockDiagram();
			case CakefeedPackage.STRUCTURED_TEXT: return createStructuredText();
			case CakefeedPackage.LADDER_DIAGRAM: return createLadderDiagram();
			case CakefeedPackage.OTHER_ALGORITHM: return createOtherAlgorithm();
			case CakefeedPackage.RUNG: return createRung();
			case CakefeedPackage.COMPOSITE_FUNCTION_BLOCK_TYPE: return createCompositeFunctionBlockType();
			case CakefeedPackage.DEVICE_TYPE: return createDeviceType();
			case CakefeedPackage.RESOURCE_TYPE: return createResourceType();
			case CakefeedPackage.BASIC_FUNCTION_BLOCK_DIAGRAM: return createBasicFunctionBlockDiagram();
			case CakefeedPackage.COMPOSITE_FUNCTION_BLOCK_DIAGRAM: return createCompositeFunctionBlockDiagram();
			case CakefeedPackage.NAMED_AND_COMMENTED: return createNamedAndCommented();
			case CakefeedPackage.IDENTIFIABLE: return createIdentifiable();
			case CakefeedPackage.COMPILABLE: return createCompilable();
			default:
	 ...
	 * @generated
	 */
	public FunctionBlockInterface createFunctionBlockInterface() {
		FunctionBlockInterfaceImpl functionBlockInterface = new FunctionBlockInterfaceImpl();
		return functionBlockInterface;
	}
	 ...
	 * @generated
	 */
	public BasicFunctionBlockType createBasicFunctionBlockType() {
		BasicFunctionBlockTypeImpl basicFunctionBlockType = new BasicFunctionBlockTypeImpl();
		return basicFunctionBlockType;
	}
	 ...
	 * @generated
	 */
	public CompositeFunctionBlockType createCompositeFunctionBlockType() {
		CompositeFunctionBlockTypeImpl compositeFunctionBlockType = new CompositeFunctionBlockTypeImpl();
		return compositeFunctionBlockType;
	}
	 ...
	 * @generated
	 */
	public BasicFunctionBlockDiagram createBasicFunctionBlockDiagram() {
		BasicFunctionBlockDiagramImpl basicFunctionBlockDiagram = new BasicFunctionBlockDiagramImpl();
		return basicFunctionBlockDiagram;
	}
	 ...
	 * @generated
	 */
	public CompositeFunctionBlockDiagram createCompositeFunctionBlockDiagram() {
		CompositeFunctionBlockDiagramImpl compositeFunctionBlockDiagram = new CompositeFunctionBlockDiagramImpl();
		return compositeFunctionBlockDiagram;
	}
	 ...
	 * @generated
	 */
	public NamedAndCommented createNamedAndCommented() {
		NamedAndCommentedImpl namedAndCommented = new NamedAndCommentedImpl();
		return namedAndCommented;
	}
	 ...
	 * @generated
	 */
	public Compilable createCompilable() {
		CompilableImpl compilable = new CompilableImpl();
		return compilable;
	}
