 ...
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ServiceTransactionImpl#getOutputPrimitives <em>Output Primitives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceTransactionImpl extends EObjectImpl implements ServiceTransaction {
	...
	/**
	 * The cached value of the '{@link #getOutputPrimitives() <em>Output Primitives</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOutputPrimitives()
	 * @generated
	 * @ordered
	 */
	protected EList<OutputPrimitive> outputPrimitives;
	 ...
	 * @generated
	 */
	public EList<OutputPrimitive> getOutputPrimitives() {
		if (outputPrimitives == null) {
			outputPrimitives = new EObjectContainmentEList<OutputPrimitive>(OutputPrimitive.class, this, CakefeedPackage.SERVICE_TRANSACTION__OUTPUT_PRIMITIVES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CakefeedPackage.SERVICE_TRANSACTION__OUTPUT_PRIMITIVES:
				return ((InternalEList<?>)getOutputPrimitives()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CakefeedPackage.SERVICE_TRANSACTION__INPUT_PRIMITIVE:
				...
				return;
			case CakefeedPackage.SERVICE_TRANSACTION__OUTPUT_PRIMITIVES:
				getOutputPrimitives().clear();
				getOutputPrimitives().addAll((Collection<? extends OutputPrimitive>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CakefeedPackage.SERVICE_TRANSACTION__OUTPUT_PRIMITIVES:
				return outputPrimitives != null && !outputPrimitives.isEmpty();
		}
