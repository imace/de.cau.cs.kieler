 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ServiceSequenceImpl#getServiceTransaction <em>Service Transaction</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ServiceSequenceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.ServiceSequenceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceSequenceImpl extends EObjectImpl implements ServiceSequence {
	...
	public EList<ServiceTransaction> getServiceTransaction() {
		if (serviceTransaction == null) {
			serviceTransaction = new EObjectContainmentEList<ServiceTransaction>(ServiceTransaction.class, this, CakefeedPackage.SERVICE_SEQUENCE__SERVICE_TRANSACTION);
		}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.SERVICE_SEQUENCE__COMMENT, oldComment, comment));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CakefeedPackage.SERVICE_SEQUENCE__NAME, oldName, name));
	}
