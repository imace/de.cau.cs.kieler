...
public class AdapterTypeImpl extends CompilableImpl implements AdapterType {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FBInterface.class) {
			switch (derivedFeatureID) {
				case CakefeedPackage.ADAPTER_TYPE__INPUT_EVENTS: return CakefeedPackage.FB_INTERFACE__INPUT_EVENTS;
				case CakefeedPackage.ADAPTER_TYPE__OUTPUT_EVENTS: return CakefeedPackage.FB_INTERFACE__OUTPUT_EVENTS;
				case CakefeedPackage.ADAPTER_TYPE__INPUT_VARS: return CakefeedPackage.FB_INTERFACE__INPUT_VARS;
				case CakefeedPackage.ADAPTER_TYPE__OUTPUT_VARS: return CakefeedPackage.FB_INTERFACE__OUTPUT_VARS;
				case CakefeedPackage.ADAPTER_TYPE__SOCKETS: return CakefeedPackage.FB_INTERFACE__SOCKETS;
				case CakefeedPackage.ADAPTER_TYPE__PLUGS: return CakefeedPackage.FB_INTERFACE__PLUGS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FBInterface.class) {
			switch (baseFeatureID) {
				case CakefeedPackage.FB_INTERFACE__INPUT_EVENTS: return CakefeedPackage.ADAPTER_TYPE__INPUT_EVENTS;
				case CakefeedPackage.FB_INTERFACE__OUTPUT_EVENTS: return CakefeedPackage.ADAPTER_TYPE__OUTPUT_EVENTS;
				case CakefeedPackage.FB_INTERFACE__INPUT_VARS: return CakefeedPackage.ADAPTER_TYPE__INPUT_VARS;
				case CakefeedPackage.FB_INTERFACE__OUTPUT_VARS: return CakefeedPackage.ADAPTER_TYPE__OUTPUT_VARS;
				case CakefeedPackage.FB_INTERFACE__SOCKETS: return CakefeedPackage.ADAPTER_TYPE__SOCKETS;
				case CakefeedPackage.FB_INTERFACE__PLUGS: return CakefeedPackage.ADAPTER_TYPE__PLUGS;
				default: return -1;
			}
		}
