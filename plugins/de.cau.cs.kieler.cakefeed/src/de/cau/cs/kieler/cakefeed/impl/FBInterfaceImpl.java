...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>FB Interface</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getInputEvents <em>Input Events</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getOutputEvents <em>Output Events</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getInputVars <em>Input Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getOutputVars <em>Output Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getSockets <em>Sockets</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.FBInterfaceImpl#getPlugs <em>Plugs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FBInterfaceImpl extends EObjectImpl implements FBInterface {
	/**
	...
	protected EClass eStaticClass() {
		return CakefeedPackage.Literals.FB_INTERFACE;
	}
	...
	public EList<IFInputEvent> getInputEvents() {
		if (inputEvents == null) {
			inputEvents = new EObjectContainmentEList<IFInputEvent>(IFInputEvent.class, this, CakefeedPackage.FB_INTERFACE__INPUT_EVENTS);
		}
		return inputEvents;
	}
	...
	public EList<IFOutputEvent> getOutputEvents() {
		if (outputEvents == null) {
			outputEvents = new EObjectContainmentEList<IFOutputEvent>(IFOutputEvent.class, this, CakefeedPackage.FB_INTERFACE__OUTPUT_EVENTS);
		}
		return outputEvents;
	}
	...
	public EList<IFInputVar> getInputVars() {
		if (inputVars == null) {
			inputVars = new EObjectContainmentEList<IFInputVar>(IFInputVar.class, this, CakefeedPackage.FB_INTERFACE__INPUT_VARS);
		}
		return inputVars;
	}
	...
	public EList<IFOutputVar> getOutputVars() {
		if (outputVars == null) {
			outputVars = new EObjectContainmentEList<IFOutputVar>(IFOutputVar.class, this, CakefeedPackage.FB_INTERFACE__OUTPUT_VARS);
		}
		return outputVars;
	}
	...
	public EList<Adapter> getSockets() {
		if (sockets == null) {
			sockets = new EObjectContainmentEList<Adapter>(Adapter.class, this, CakefeedPackage.FB_INTERFACE__SOCKETS);
		}
		return sockets;
	}
	...
	public EList<Adapter> getPlugs() {
		if (plugs == null) {
			plugs = new EObjectContainmentEList<Adapter>(Adapter.class, this, CakefeedPackage.FB_INTERFACE__PLUGS);
		}
		return plugs;
	}
