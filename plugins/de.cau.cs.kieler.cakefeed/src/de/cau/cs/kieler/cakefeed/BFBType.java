 ...
 *   <li>{@link de.cau.cs.kieler.cakefeed.BFBType#getFunctionBlockDiagrams <em>Function Block Diagrams</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.BFBType#getSTs <em>STs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.cakefeed.BFBType#getLadderDiagrams <em>Ladder Diagrams</em>}</li>
...
public interface BFBType extends FBType {
	 ...
	 * @see de.cau.cs.kieler.cakefeed.CakefeedPackage#getBFBType_FunctionBlockDiagrams()
	 * @model containment="true"
	 * @generated
	 */
	EList<FBD> getFunctionBlockDiagrams();
	 ...
	 * @see de.cau.cs.kieler.cakefeed.CakefeedPackage#getBFBType_LadderDiagrams()
	 * @model containment="true"
	 * @generated
	 */
	EList<LD> getLadderDiagrams();
