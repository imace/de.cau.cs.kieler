...
public class CakefeedSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CakefeedPackage.FB: {
				FB fb = (FB)theEObject;
				T result = caseFB(fb);
				if (result == null) result = caseNamedAndCommented(fb);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CakefeedPackage.FB_INTERFACE: {
				FBInterface fbInterface = (FBInterface)theEObject;
				T result = caseFBInterface(fbInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CakefeedPackage.FB_TYPE: {
				...
				if (result == null) result = caseCompilable(fbType);
				if (result == null) result = caseNamedAndCommented(fbType);
				if (result == null) result = caseFBInterface(fbType);
				if (result == null) result = caseIdentifiable(fbType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CakefeedPackage.ADAPTER_TYPE: {
				...
				if (result == null) result = caseFBInterface(adapterType);
			...
			case CakefeedPackage.BFB_TYPE: {
				...
				if (result == null) result = caseCompilable(bfbType);
				if (result == null) result = caseNamedAndCommented(bfbType);
				if (result == null) result = caseFBInterface(bfbType);
				if (result == null) result = caseIdentifiable(bfbType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CakefeedPackage.FBD: {
				...
				if (result == null) result = caseNamedAndCommented(fbd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CakefeedPackage.ST: {
				ST st = (ST)theEObject;
				T result = caseST(st);
				if (result == null) result = caseNamedAndCommented(st);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CakefeedPackage.LD: {
				LD ld = (LD)theEObject;
				T result = caseLD(ld);
				if (result == null) result = caseNamedAndCommented(ld);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CakefeedPackage.OTHER: {
				...
				if (result == null) result = caseNamedAndCommented(other);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CakefeedPackage.CFB_TYPE: {
				...
				if (result == null) result = caseFBNetwork(cfbType);
				if (result == null) result = caseCompilable(cfbType);
				if (result == null) result = caseNamedAndCommented(cfbType);
				if (result == null) result = caseFBInterface(cfbType);
				if (result == null) result = caseIdentifiable(cfbType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FB Interface</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FB Interface</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFBInterface(FBInterface object) {
		return null;
	}
