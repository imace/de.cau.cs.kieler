 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.cakefeed.impl.LadderDiagramImpl#getRungs <em>Rungs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LadderDiagramImpl extends NamedAndCommentedImpl implements LadderDiagram {
	/**
	...
	protected EClass eStaticClass() {
		return CakefeedPackage.Literals.LADDER_DIAGRAM;
	}
	...
	public EList<Rung> getRungs() {
		if (rungs == null) {
			rungs = new EObjectContainmentEList<Rung>(Rung.class, this, CakefeedPackage.LADDER_DIAGRAM__RUNGS);
		}
		return rungs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CakefeedPackage.LADDER_DIAGRAM__RUNGS:
