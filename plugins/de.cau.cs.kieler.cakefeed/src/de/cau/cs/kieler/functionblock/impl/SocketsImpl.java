 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SocketsImpl#getAdapterDeclaration <em>Adapter Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SocketsImpl extends EObjectImpl implements Sockets {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.SOCKETS;
	}
	...
	public EList<AdapterDeclaration> getAdapterDeclaration() {
		if (adapterDeclaration == null) {
			adapterDeclaration = new EObjectContainmentEList<AdapterDeclaration>(AdapterDeclaration.class, this, FunctionblockPackage.SOCKETS__ADAPTER_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.SOCKETS__ADAPTER_DECLARATION:
