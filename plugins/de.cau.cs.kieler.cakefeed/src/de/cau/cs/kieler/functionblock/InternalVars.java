 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.InternalVars#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getInternalVars()
...
public interface InternalVars extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getInternalVars_VarDeclaration()
