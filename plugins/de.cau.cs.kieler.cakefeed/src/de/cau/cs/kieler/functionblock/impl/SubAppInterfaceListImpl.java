 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SubAppInterfaceListImpl#getSubAppEventInputs <em>Sub App Event Inputs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SubAppInterfaceListImpl#getSubAppEventOutputs <em>Sub App Event Outputs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SubAppInterfaceListImpl#getInputVars <em>Input Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SubAppInterfaceListImpl#getOutputVars <em>Output Vars</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubAppInterfaceListImpl extends EObjectImpl implements SubAppInterfaceList {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.SUB_APP_INTERFACE_LIST;
	}
	...
	public NotificationChain basicSetSubAppEventInputs(SubAppEventInputs newSubAppEventInputs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_INPUTS, oldSubAppEventInputs, newSubAppEventInputs);
	...
	public void setSubAppEventInputs(SubAppEventInputs newSubAppEventInputs) {
		if (newSubAppEventInputs != subAppEventInputs) {
			...
			if (subAppEventInputs != null)
				msgs = ((InternalEObject)subAppEventInputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_INPUTS, null, msgs);
			if (newSubAppEventInputs != null)
				msgs = ((InternalEObject)newSubAppEventInputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_INPUTS, null, msgs);
			msgs = basicSetSubAppEventInputs(newSubAppEventInputs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_INPUTS, newSubAppEventInputs, newSubAppEventInputs));
	}
	...
	public NotificationChain basicSetSubAppEventOutputs(SubAppEventOutputs newSubAppEventOutputs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_OUTPUTS, oldSubAppEventOutputs, newSubAppEventOutputs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSubAppEventOutputs(SubAppEventOutputs newSubAppEventOutputs) {
		if (newSubAppEventOutputs != subAppEventOutputs) {
			...
			if (subAppEventOutputs != null)
				msgs = ((InternalEObject)subAppEventOutputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_OUTPUTS, null, msgs);
			if (newSubAppEventOutputs != null)
				msgs = ((InternalEObject)newSubAppEventOutputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_OUTPUTS, null, msgs);
			msgs = basicSetSubAppEventOutputs(newSubAppEventOutputs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_OUTPUTS, newSubAppEventOutputs, newSubAppEventOutputs));
	}
	...
	public NotificationChain basicSetInputVars(InputVars newInputVars, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__INPUT_VARS, oldInputVars, newInputVars);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInputVars(InputVars newInputVars) {
		if (newInputVars != inputVars) {
			NotificationChain msgs = null;
			if (inputVars != null)
				msgs = ((InternalEObject)inputVars).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__INPUT_VARS, null, msgs);
			if (newInputVars != null)
				msgs = ((InternalEObject)newInputVars).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__INPUT_VARS, null, msgs);
			msgs = basicSetInputVars(newInputVars, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__INPUT_VARS, newInputVars, newInputVars));
	}
	...
	public NotificationChain basicSetOutputVars(OutputVars newOutputVars, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__OUTPUT_VARS, oldOutputVars, newOutputVars);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOutputVars(OutputVars newOutputVars) {
		if (newOutputVars != outputVars) {
			NotificationChain msgs = null;
			if (outputVars != null)
				msgs = ((InternalEObject)outputVars).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__OUTPUT_VARS, null, msgs);
			if (newOutputVars != null)
				msgs = ((InternalEObject)newOutputVars).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.SUB_APP_INTERFACE_LIST__OUTPUT_VARS, null, msgs);
			msgs = basicSetOutputVars(newOutputVars, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SUB_APP_INTERFACE_LIST__OUTPUT_VARS, newOutputVars, newOutputVars));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_INPUTS:
				return basicSetSubAppEventInputs(null, msgs);
			case FunctionblockPackage.SUB_APP_INTERFACE_LIST__SUB_APP_EVENT_OUTPUTS:
				return basicSetSubAppEventOutputs(null, msgs);
			case FunctionblockPackage.SUB_APP_INTERFACE_LIST__INPUT_VARS:
				return basicSetInputVars(null, msgs);
			case FunctionblockPackage.SUB_APP_INTERFACE_LIST__OUTPUT_VARS:
