 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.SubAppEventOutputsImpl#getSubAppEvent <em>Sub App Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubAppEventOutputsImpl extends EObjectImpl implements SubAppEventOutputs {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.SUB_APP_EVENT_OUTPUTS;
	}
	...
	public EList<SubAppEvent> getSubAppEvent() {
		if (subAppEvent == null) {
			subAppEvent = new EObjectContainmentEList<SubAppEvent>(SubAppEvent.class, this, FunctionblockPackage.SUB_APP_EVENT_OUTPUTS__SUB_APP_EVENT);
		}
		return subAppEvent;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.SUB_APP_EVENT_OUTPUTS__SUB_APP_EVENT:
