 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.WithImpl#getVar <em>Var</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WithImpl extends EObjectImpl implements With {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.WITH;
	}
	...
	public void setVar(String newVar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.WITH__VAR, oldVar, var));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblockPackage.WITH__VAR:
				return getVar();
		}
