 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.LDImpl#getRung <em>Rung</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LDImpl extends EObjectImpl implements LD {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.LD;
	}
	...
	public EList<Rung> getRung() {
		if (rung == null) {
			rung = new EObjectContainmentEList<Rung>(Rung.class, this, FunctionblockPackage.LD__RUNG);
		}
		return rung;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.LD__RUNG:
