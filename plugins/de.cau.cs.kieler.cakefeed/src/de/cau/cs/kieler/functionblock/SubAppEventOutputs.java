 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppEventOutputs#getSubAppEvent <em>Sub App Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppEventOutputs()
...
public interface SubAppEventOutputs extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppEventOutputs_SubAppEvent()
