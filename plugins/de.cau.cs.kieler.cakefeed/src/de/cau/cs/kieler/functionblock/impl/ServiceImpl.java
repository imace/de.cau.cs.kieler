 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceImpl#getServiceSequence <em>Service Sequence</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceImpl#getLeftInterface <em>Left Interface</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceImpl#getRightInterface <em>Right Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceImpl extends EObjectImpl implements Service {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.SERVICE;
	}
	...
	public EList<ServiceSequence> getServiceSequence() {
		if (serviceSequence == null) {
			serviceSequence = new EObjectContainmentEList<ServiceSequence>(ServiceSequence.class, this, FunctionblockPackage.SERVICE__SERVICE_SEQUENCE);
		}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SERVICE__COMMENT, oldComment, comment));
	}
	...
	public void setLeftInterface(String newLeftInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SERVICE__LEFT_INTERFACE, oldLeftInterface, leftInterface));
	}
	...
	public void setRightInterface(String newRightInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.SERVICE__RIGHT_INTERFACE, oldRightInterface, rightInterface));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.SERVICE__SERVICE_SEQUENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FunctionblockPackage.SERVICE__COMMENT:
				return getComment();
			case FunctionblockPackage.SERVICE__LEFT_INTERFACE:
				return getLeftInterface();
			case FunctionblockPackage.SERVICE__RIGHT_INTERFACE:
