 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceTransactionImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceTransactionImpl#getInputPrimitive <em>Input Primitive</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ServiceTransactionImpl#getOutputPrimitive <em>Output Primitive</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceTransactionImpl extends EObjectImpl implements ServiceTransaction {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.SERVICE_TRANSACTION;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, FunctionblockPackage.SERVICE_TRANSACTION__MIXED);
		}
		return mixed;
	}
	...
	public InputPrimitive getInputPrimitive() {
		return (InputPrimitive)getMixed().get(FunctionblockPackage.Literals.SERVICE_TRANSACTION__INPUT_PRIMITIVE, true);
	}
	...
	public NotificationChain basicSetInputPrimitive(InputPrimitive newInputPrimitive, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(FunctionblockPackage.Literals.SERVICE_TRANSACTION__INPUT_PRIMITIVE, newInputPrimitive, msgs);
	}
	...
	public void setInputPrimitive(InputPrimitive newInputPrimitive) {
		((FeatureMap.Internal)getMixed()).set(FunctionblockPackage.Literals.SERVICE_TRANSACTION__INPUT_PRIMITIVE, newInputPrimitive);
	}
	...
	public EList<OutputPrimitive> getOutputPrimitive() {
		return getMixed().list(FunctionblockPackage.Literals.SERVICE_TRANSACTION__OUTPUT_PRIMITIVE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.SERVICE_TRANSACTION__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case FunctionblockPackage.SERVICE_TRANSACTION__INPUT_PRIMITIVE:
				return basicSetInputPrimitive(null, msgs);
			case FunctionblockPackage.SERVICE_TRANSACTION__OUTPUT_PRIMITIVE:
