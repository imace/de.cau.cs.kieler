 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getApplicationDomain <em>Application Domain</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getClassification <em>Classification</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getStandard <em>Standard</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.IdentificationImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentificationImpl extends EObjectImpl implements Identification {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.IDENTIFICATION;
	}
	...
	public void setApplicationDomain(String newApplicationDomain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__APPLICATION_DOMAIN, oldApplicationDomain, applicationDomain));
	}
	...
	public void setClassification(String newClassification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__CLASSIFICATION, oldClassification, classification));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__DESCRIPTION, oldDescription, description));
	}
	...
	public void setFunction(String newFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__FUNCTION, oldFunction, function));
	}
	...
	public void setStandard(String newStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__STANDARD, oldStandard, standard));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.IDENTIFICATION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblockPackage.IDENTIFICATION__APPLICATION_DOMAIN:
				return getApplicationDomain();
			case FunctionblockPackage.IDENTIFICATION__CLASSIFICATION:
				return getClassification();
			case FunctionblockPackage.IDENTIFICATION__DESCRIPTION:
				return getDescription();
			case FunctionblockPackage.IDENTIFICATION__FUNCTION:
				return getFunction();
			case FunctionblockPackage.IDENTIFICATION__STANDARD:
				return getStandard();
			case FunctionblockPackage.IDENTIFICATION__TYPE:
				return getType();
		}
