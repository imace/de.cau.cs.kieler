 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getSubAppEventInputs <em>Sub App Event Inputs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getSubAppEventOutputs <em>Sub App Event Outputs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getInputVars <em>Input Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getOutputVars <em>Output Vars</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppInterfaceList()
...
public interface SubAppInterfaceList extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppInterfaceList_SubAppEventInputs()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getSubAppEventInputs <em>Sub App Event Inputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppInterfaceList_SubAppEventOutputs()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getSubAppEventOutputs <em>Sub App Event Outputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppInterfaceList_InputVars()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getInputVars <em>Input Vars</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppInterfaceList_OutputVars()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppInterfaceList#getOutputVars <em>Output Vars</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
