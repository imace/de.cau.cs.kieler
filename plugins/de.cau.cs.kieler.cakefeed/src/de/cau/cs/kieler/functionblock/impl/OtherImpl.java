 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.OtherImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.OtherImpl#getPrototype <em>Prototype</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.OtherImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OtherImpl extends EObjectImpl implements Other {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.OTHER;
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OTHER__LANGUAGE, oldLanguage, language));
	}
	...
	public void setPrototype(String newPrototype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OTHER__PROTOTYPE, oldPrototype, prototype));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OTHER__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionblockPackage.OTHER__LANGUAGE:
				return getLanguage();
			case FunctionblockPackage.OTHER__PROTOTYPE:
				return getPrototype();
			case FunctionblockPackage.OTHER__TEXT:
				return getText();
		}
