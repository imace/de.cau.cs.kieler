 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.InputVarsImpl#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputVarsImpl extends EObjectImpl implements InputVars {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.INPUT_VARS;
	}
	...
	public EList<VarDeclaration> getVarDeclaration() {
		if (varDeclaration == null) {
			varDeclaration = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, FunctionblockPackage.INPUT_VARS__VAR_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.INPUT_VARS__VAR_DECLARATION:
