 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.InternalVarsImpl#getVarDeclaration <em>Var Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InternalVarsImpl extends EObjectImpl implements InternalVars {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.INTERNAL_VARS;
	}
	...
	public EList<VarDeclaration> getVarDeclaration() {
		if (varDeclaration == null) {
			varDeclaration = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, FunctionblockPackage.INTERNAL_VARS__VAR_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.INTERNAL_VARS__VAR_DECLARATION:
