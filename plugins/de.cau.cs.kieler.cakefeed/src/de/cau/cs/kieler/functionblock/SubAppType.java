 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getIdentification <em>Identification</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getVersionInfo <em>Version Info</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getCompilerInfo <em>Compiler Info</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getSubAppInterfaceList <em>Sub App Interface List</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getSubAppNetwork <em>Sub App Network</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getComment <em>Comment</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.SubAppType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType()
...
public interface SubAppType extends EObject {
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_Identification()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getIdentification <em>Identification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_VersionInfo()
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_CompilerInfo()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getCompilerInfo <em>Compiler Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_SubAppInterfaceList()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getSubAppInterfaceList <em>Sub App Interface List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_SubAppNetwork()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getSubAppNetwork <em>Sub App Network</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_Comment()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getComment <em>Comment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see de.cau.cs.kieler.functionblock.FunctionblockPackage#getSubAppType_Name()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.functionblock.SubAppType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
