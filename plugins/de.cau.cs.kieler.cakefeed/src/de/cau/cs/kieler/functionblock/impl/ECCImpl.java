 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ECCImpl#getECState <em>EC State</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ECCImpl#getECTransition <em>EC Transition</em>}</li>
 *   <li>{@link de.cau.cs.kieler.functionblock.impl.ECCImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ECCImpl extends EObjectImpl implements ECC {
	...
	protected EClass eStaticClass() {
		return FunctionblockPackage.Literals.ECC;
	}
	...
	public EList<ECState> getECState() {
		if (eCState == null) {
			eCState = new EObjectContainmentEList<ECState>(ECState.class, this, FunctionblockPackage.ECC__EC_STATE);
		}
		return eCState;
	}
	...
	public EList<ECTransition> getECTransition() {
		if (eCTransition == null) {
			eCTransition = new EObjectContainmentEList<ECTransition>(ECTransition.class, this, FunctionblockPackage.ECC__EC_TRANSITION);
		}
		return eCTransition;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.ECC__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionblockPackage.ECC__EC_STATE:
				return ((InternalEList<?>)getECState()).basicRemove(otherEnd, msgs);
			case FunctionblockPackage.ECC__EC_TRANSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FunctionblockPackage.ECC__NAME:
				return getName();
		}
