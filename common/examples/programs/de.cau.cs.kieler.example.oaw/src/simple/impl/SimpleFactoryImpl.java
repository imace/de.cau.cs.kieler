...
public class SimpleFactoryImpl extends EFactoryImpl implements SimpleFactory {
	...
	public static SimpleFactory init() {
		try {
			SimpleFactory theSimpleFactory = (SimpleFactory)EPackage.Registry.INSTANCE.getEFactory("http://simple/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SimplePackage.SIMPLE_MODEL: return createSimpleModel();
			case SimplePackage.DATA: return createData();
			default:
