...
import de.cau.cs.kieler.synccharts.diagram.edit.parts.StateVariableCompartment2EditPart;
...
public class AddVariable2Action implements IActionDelegate {
	...
	public void run(IAction action) {
		...
		CreateViewRequest variableRequest = CreateViewRequestFactory.getCreateShapeRequest(SyncchartsElementTypes.Variable_3010, selectedElement.getDiagramPreferencesHint());
