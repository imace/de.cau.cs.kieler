...
public class AddStateAction implements IActionDelegate {
	...
	public void run(IAction action) {
		...
		CreateViewRequest stateRequest = CreateViewRequestFactory.getCreateShapeRequest(SyncchartsElementTypes.State_2012, selectedElement.getDiagramPreferencesHint());
