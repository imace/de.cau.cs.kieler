...
public class AddInnerActionAction implements IActionDelegate {
	...
	public void run(IAction action) {
		...
		CreateViewRequest actionRequest = CreateViewRequestFactory.getCreateShapeRequest(SyncchartsElementTypes.Action_3004, selectedElement.getDiagramPreferencesHint());

		Command createActionCmd = innerActionsCompartment.getCommand(actionRequest);
