...
/**
 * This is the item provider adapter for a {@link hierarchymealy.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MealyPackage.Literals.EDGE__SOURCE_NODE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MealyPackage.Literals.EDGE__TARGET_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTriggerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_trigger_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_trigger_feature", "_UI_Edge_type"),
				 MealyPackage.Literals.EDGE__TRIGGER,
				 true,
				 false,
				 false,
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_action_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_action_feature", "_UI_Edge_type"),
				 MealyPackage.Literals.EDGE__ACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Edge)object).getTrigger();
	...
	public ResourceLocator getResourceLocator() {
		return MealyMachineEditPlugin.INSTANCE;
	}
