 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.impl.ExpressionImpl#getParentSuspensionTrigger <em>Parent Suspension Trigger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionImpl extends EObjectImpl implements Expression {
     ...
     * @generated
     */
	public SuspensionTrigger getParentSuspensionTrigger() {
        if (eContainerFeatureID != SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER) return null;
        return (SuspensionTrigger)eContainer();
    }
     ...
     * @generated
     */
	public NotificationChain basicSetParentSuspensionTrigger(SuspensionTrigger newParentSuspensionTrigger, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newParentSuspensionTrigger, SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER, msgs);
        return msgs;
    }
     ...
     * @generated
     */
	public void setParentSuspensionTrigger(SuspensionTrigger newParentSuspensionTrigger) {
        if (newParentSuspensionTrigger != eInternalContainer() || (eContainerFeatureID != SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER && newParentSuspensionTrigger != null)) {
            if (EcoreUtil.isAncestor(this, newParentSuspensionTrigger))
                throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
            NotificationChain msgs = null;
            if (eInternalContainer() != null)
                msgs = eBasicRemoveFromContainer(msgs);
            if (newParentSuspensionTrigger != null)
                msgs = ((InternalEObject)newParentSuspensionTrigger).eInverseAdd(this, SyncchartsPackage.SUSPENSION_TRIGGER__EXPRESSION, SuspensionTrigger.class, msgs);
            msgs = basicSetParentSuspensionTrigger(newParentSuspensionTrigger, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER, newParentSuspensionTrigger, newParentSuspensionTrigger));
    }
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
                return basicSetParentSuspensionTrigger((SuspensionTrigger)otherEnd, msgs);
        }
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                return basicSetParentSuspensionTrigger(null, msgs);
        }
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                return eInternalContainer().eInverseRemove(this, SyncchartsPackage.SUSPENSION_TRIGGER__EXPRESSION, SuspensionTrigger.class, msgs);
        }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                return getParentSuspensionTrigger();
        }
	...
	public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_EXPRESSION:
                ...
                return;
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                setParentSuspensionTrigger((SuspensionTrigger)newValue);
                return;
        }
	...
	public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_EXPRESSION:
                ...
                return;
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                setParentSuspensionTrigger((SuspensionTrigger)null);
                return;
        }
	...
	public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case SyncchartsPackage.EXPRESSION__PARENT_SUSPENSION_TRIGGER:
                return getParentSuspensionTrigger() != null;
        }
