 ...
 */
package de.cau.cs.kieler.synccharts.custom.handlers;
...
public class AddToStateHandler extends AbstractHandler implements IHandler {
    ...
    private void addElement(ShapeNodeEditPart stateEditPart, String type) {
        ...
        if (type.equals(VAL_ENTRY_ACTION)) {
            ...
            elementType = SyncchartsElementTypes.Action_3003;
        }
            ...
            elementType = SyncchartsElementTypes.Variable_3010;
        }
            ...
            elementType = SyncchartsElementTypes.SuspensionTrigger_3011;
        }
        else return;
