...
public class ssmPackageImpl extends EPackageImpl implements ssmPackage {
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getCondition_SubConditions() {
	 ...
	 * @generated
	 */
	public EAttribute getCondition_CombinationOperator() {
	 ...
	 * @generated
	 */
	public EAttribute getCondition_Literals() {
	...
	public void createPackageContents() {
		...
		createEReference(conditionEClass, CONDITION__SUB_CONDITIONS);
		createEAttribute(conditionEClass, CONDITION__COMBINATION_OPERATOR);
		createEAttribute(conditionEClass, CONDITION__LITERALS);
	...
	public void initializePackageContents() {
		...
		initEReference(getCondition_SubConditions(), this.getCondition(), null, "subConditions", null, 0, -1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCondition_CombinationOperator(), this.getCombinationOperator(), "combinationOperator", null, 1, 1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCondition_Literals(), this.getAnyType(), "literals", null, 0, -1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.PURESIGNALAND);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.PURESIGNALOR);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.PURESIGNALNOT);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.INTSIGNALADD);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.INTSIGNALMUL);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.INTSIGNALGT);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.INTSIGNALLT);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.STRINGSIGNALCONCAT);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.INTSIGNALEQ);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.STRINGSIGNALEQ);
		addEEnumLiteral(combinationOperatorEEnum, CombinationOperator.PURESIGNALEQ);
