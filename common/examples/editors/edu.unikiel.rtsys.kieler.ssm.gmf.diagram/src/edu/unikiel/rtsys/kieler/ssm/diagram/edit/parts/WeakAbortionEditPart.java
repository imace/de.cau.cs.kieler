...
import edu.unikiel.rtsys.kieler.ssm.diagram.edit.policies.WeakAbortionItemSemanticEditPolicy;

/**
 * @generated
 */
public class WeakAbortionEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public WeakAbortionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WeakAbortionItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WeakAbortionIsImmediateStringTriggeEditPart) {
			((WeakAbortionIsImmediateStringTriggeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureWeakAbortionLabelLabel());
			return true;
		}
		if (childEditPart instanceof WeakAbortionPriorityEditPart) {
			((WeakAbortionPriorityEditPart) childEditPart)
					.setLabel(getPrimaryShape()
