...
public class SafeStateMachineVisualIDRegistry {
    ...
    public static int getNodeVisualID(View containerView, EObject domainElement) {
        ...
        case RegionRegionCompartmentEditPart.VISUAL_ID:
            if (edu.unikiel.rtsys.kieler.ssm.ssmPackage.eINSTANCE
                ...
                return CompositeState3EditPart.VISUAL_ID;
            }
            if (edu.unikiel.rtsys.kieler.ssm.ssmPackage.eINSTANCE
    ...
    public static boolean canCreateNode(View containerView, int nodeVisualID) {
        ...
        case CompositeStateCompositeStateCompartmentEditPart.VISUAL_ID:
            ...
            break;
        case RegionRegionCompartmentEditPart.VISUAL_ID:
            if (CompositeState3EditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
        ...
        case StrongAbortion2EditPart.VISUAL_ID:
            if (StrongAbortionPriority2EditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
            if (StrongAbortionIsImmediateStringTrigge2EditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
            break;
    ...
    public static int getLinkWithClassVisualID(EObject domainElement) {
        ...
        if (edu.unikiel.rtsys.kieler.ssm.ssmPackage.eINSTANCE
            ...
            return StrongAbortion2EditPart.VISUAL_ID;
        }
        if (edu.unikiel.rtsys.kieler.ssm.ssmPackage.eINSTANCE
