    ...
    public EditPart createEditPart(EditPart context, Object model) {
        if (model instanceof View) {
            ...
            case CompositeState3EditPart.VISUAL_ID:
                return new CompositeState3EditPart(view);
            ...
            case StrongAbortion2EditPart.VISUAL_ID:
                return new StrongAbortion2EditPart(view);

            case StrongAbortionPriority2EditPart.VISUAL_ID:
                return new StrongAbortionPriority2EditPart(view);

            case StrongAbortionIsImmediateStringTrigge2EditPart.VISUAL_ID:
                return new StrongAbortionIsImmediateStringTrigge2EditPart(view);
