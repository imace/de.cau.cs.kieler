 ...
 * @generated
 */
public class SafeStateMachineNavigatorActionProvider extends
    ...
    private class OpenDiagramAction extends Action {
        ...
        public final void selectionChanged(IStructuredSelection selection) {
            ...
            if (selection.size() == 1) {
                ...
                if (selectedElement instanceof SafeStateMachineNavigatorItem) {
                    selectedElement = ((SafeStateMachineNavigatorItem) selectedElement)
                            .getView();
        ...
        public void run() {
            ...
            try {
                page.openEditor(editorInput, SafeStateMachineDiagramEditor.ID);
