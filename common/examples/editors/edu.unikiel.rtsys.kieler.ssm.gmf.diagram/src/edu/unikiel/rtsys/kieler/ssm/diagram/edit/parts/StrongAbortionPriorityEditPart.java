 ...
 * @generated
 */
public class StrongAbortionPriorityEditPart extends LabelEditPart implements
        ITextAwareEditPart {
    ...
    static {
        registerSnapBackPosition(
                SafeStateMachineVisualIDRegistry
                        .getType(edu.unikiel.rtsys.kieler.ssm.diagram.edit.parts.StrongAbortionPriorityEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public StrongAbortionPriorityEditPart(View view) {
        super(view);
    }
