...
import edu.unikiel.rtsys.kieler.ssm.diagram.edit.helpers.SafeStateMachineBaseEditHelper;
import edu.unikiel.rtsys.kieler.ssm.diagram.part.SafeStateMachineVisualIDRegistry;

/**
 * @generated
 */
public class SafeStateMachineBaseItemSemanticEditPolicy extends
        SemanticEditPolicy {
    ...
    public Command getCommand(Request request) {
        if (request instanceof ReconnectRequest) {
            ...
            if (view instanceof View) {
                Integer id = new Integer(SafeStateMachineVisualIDRegistry
        ...
        if (elementType != null) {
            if (semanticCommand != null) {
                ...
                completedRequest.setParameter(
                        SafeStateMachineBaseEditHelper.EDIT_POLICY_COMMAND,
                        command);
            }
