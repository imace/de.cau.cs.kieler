...
import edu.unikiel.rtsys.kieler.ssm.diagram.part.Messages;
import edu.unikiel.rtsys.kieler.ssm.diagram.part.SafeStateMachineVisualIDRegistry;

/**
 * @generated
 */
public class SafeStateMachineNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SafeStateMachineNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), SafeStateMachineEditPart.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof SafeStateMachineNavigatorGroup) {
			SafeStateMachineNavigatorGroup group = (SafeStateMachineNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof SafeStateMachineNavigatorItem) {
			SafeStateMachineNavigatorItem navigatorItem = (SafeStateMachineNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SafeStateMachineEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup links = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_SafeStateMachine_1000_links,
		...
		case CompositeStateEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup incominglinks = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_CompositeState_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup outgoinglinks = new SafeStateMachineNavigatorGroup(
			...
			outgoinglinks.addChildren(createNavigatorItems(connectedViews,
					outgoinglinks, true));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), WeakAbortionEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), WeakAbortionEditPart.VISUAL_ID);
		...
		case RegionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), RegionRegionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					CompositeState2EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RegionRegionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					SimpleStateEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RegionRegionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					InitialStateEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case SimpleStateEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup incominglinks = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_SimpleState_3003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup outgoinglinks = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_SimpleState_3003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), StrongAbortionEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view),
		...
		case InitialStateEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup incominglinks = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_InitialState_3004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup outgoinglinks = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_InitialState_3004_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), StrongAbortionEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case StrongAbortionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup target = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_StrongAbortion_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup source = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_StrongAbortion_4001_source,
		...
		case NormalTerminationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup target = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_NormalTermination_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup source = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_NormalTermination_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), CompositeStateEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case WeakAbortionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SafeStateMachineNavigatorGroup target = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_WeakAbortion_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SafeStateMachineNavigatorGroup source = new SafeStateMachineNavigatorGroup(
					Messages.NavigatorGroupName_WeakAbortion_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), CompositeStateEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = SafeStateMachineVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new SafeStateMachineNavigatorItem((View) it.next(),
					parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof SafeStateMachineAbstractNavigatorItem) {
			SafeStateMachineAbstractNavigatorItem abstractNavigatorItem = (SafeStateMachineAbstractNavigatorItem) element;
