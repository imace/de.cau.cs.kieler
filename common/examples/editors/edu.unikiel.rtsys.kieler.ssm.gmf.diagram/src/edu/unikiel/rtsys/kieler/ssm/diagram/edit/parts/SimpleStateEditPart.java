...
import edu.unikiel.rtsys.kieler.ssm.diagram.edit.policies.SimpleStateItemSemanticEditPolicy;
...
public class SimpleStateEditPart extends ShapeNodeEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new SimpleStateItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof SimpleStateNameEditPart) {
            ((SimpleStateNameEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureSimpleStateNameLabel());
            return true;
        }
        return false;
    }
    ...
    public class SimpleStateFigure extends RoundedRectangle {
         ...
         * @generated
         */
        private WrappingLabel fFigureSimpleStateNameLabel;
        ...
        private void createContents() {
            ...
            fFigureSimpleStateNameLabel = new WrappingLabel();
            fFigureSimpleStateNameLabel.setText("<..>");

            this.add(fFigureSimpleStateNameLabel);
         ...
         * @generated
         */
        public WrappingLabel getFigureSimpleStateNameLabel() {
            return fFigureSimpleStateNameLabel;
        }
