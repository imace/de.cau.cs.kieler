 ...
 * @generated
 */
public class NormalTerminationPriorityEditPart extends LabelEditPart implements
        ITextAwareEditPart {
    ...
    static {
        registerSnapBackPosition(
                SafeStateMachineVisualIDRegistry
                        .getType(edu.unikiel.rtsys.kieler.ssm.diagram.edit.parts.NormalTerminationPriorityEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public NormalTerminationPriorityEditPart(View view) {
        super(view);
    }
