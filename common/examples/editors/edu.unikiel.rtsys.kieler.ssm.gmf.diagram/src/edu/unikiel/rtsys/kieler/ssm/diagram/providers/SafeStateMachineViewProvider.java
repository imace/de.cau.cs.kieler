...
import edu.unikiel.rtsys.kieler.ssm.diagram.view.factories.CompositeState3ViewFactory;
...
import edu.unikiel.rtsys.kieler.ssm.diagram.view.factories.StrongAbortion2ViewFactory;
import edu.unikiel.rtsys.kieler.ssm.diagram.view.factories.StrongAbortionIsImmediateStringTrigge2ViewFactory;
import edu.unikiel.rtsys.kieler.ssm.diagram.view.factories.StrongAbortionIsImmediateStringTriggeViewFactory;
import edu.unikiel.rtsys.kieler.ssm.diagram.view.factories.StrongAbortionPriority2ViewFactory;
...
public class SafeStateMachineViewProvider extends AbstractViewProvider {
        ...
        if (semanticHint == null) {
            ...
            if (elementType != null) {
                ...
                case CompositeStateCompositeStateCompartment2EditPart.VISUAL_ID:
                    if (CompositeState3EditPart.VISUAL_ID != SafeStateMachineVisualIDRegistry
                            .getVisualID(containerView)
                            || containerView.getElement() != domainElement) {
                        return null; // wrong container
                    }
    ...
    protected Class getNodeViewClass(View containerView, int visualID) {
        ...
        case CompositeState3EditPart.VISUAL_ID:
            return CompositeState3ViewFactory.class;
        case CompositeStateName2EditPart.VISUAL_ID:
        ...
        case StrongAbortionPriority2EditPart.VISUAL_ID:
            return StrongAbortionPriority2ViewFactory.class;
        case StrongAbortionIsImmediateStringTrigge2EditPart.VISUAL_ID:
            return StrongAbortionIsImmediateStringTrigge2ViewFactory.class;
        case StrongAbortionPriorityEditPart.VISUAL_ID:
    ...
    protected Class getEdgeViewClass(int visualID) {
        ...
        case StrongAbortion2EditPart.VISUAL_ID:
            return StrongAbortion2ViewFactory.class;
