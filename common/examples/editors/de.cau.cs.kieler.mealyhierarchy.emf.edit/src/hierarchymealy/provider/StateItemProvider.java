...
/**
 * This is the item provider adapter for a {@link hierarchymealy.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_outgoingEdges_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_outgoingEdges_feature", "_UI_State_type"),
				 MealyPackage.Literals.STATE__OUTGOING_EDGES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncomingEdgesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_incomingEdges_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_incomingEdges_feature", "_UI_State_type"),
				 MealyPackage.Literals.STATE__INCOMING_EDGES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MealyPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
