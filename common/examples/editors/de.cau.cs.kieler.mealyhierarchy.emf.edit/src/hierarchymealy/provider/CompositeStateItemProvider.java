...
/**
 * This is the item provider adapter for a {@link hierarchymealy.CompositeState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeStateItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MealyPackage.Literals.COMPOSITE_STATE__NODES);
			childrenFeatures.add(MealyPackage.Literals.COMPOSITE_STATE__EDGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MealyPackage.Literals.COMPOSITE_STATE__NODES,
				 MealyFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(MealyPackage.Literals.COMPOSITE_STATE__NODES,
				 MealyFactory.eINSTANCE.createCompositeState()));

		newChildDescriptors.add
			(createChildParameter
				(MealyPackage.Literals.COMPOSITE_STATE__NODES,
				 MealyFactory.eINSTANCE.createHierarchyMealyMachine()));

		newChildDescriptors.add
			(createChildParameter
				(MealyPackage.Literals.COMPOSITE_STATE__EDGES,
				 MealyFactory.eINSTANCE.createEdge()));
	}
