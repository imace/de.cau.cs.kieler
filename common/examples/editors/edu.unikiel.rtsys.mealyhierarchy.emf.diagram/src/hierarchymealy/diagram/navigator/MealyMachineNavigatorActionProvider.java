...
import hierarchymealy.diagram.part.MealyMachineDiagramEditor;
 ...
 * @generated
 */
public class MealyMachineNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof MealyMachineNavigatorItem) {
					selectedElement = ((MealyMachineNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, MealyMachineDiagramEditor.ID);
