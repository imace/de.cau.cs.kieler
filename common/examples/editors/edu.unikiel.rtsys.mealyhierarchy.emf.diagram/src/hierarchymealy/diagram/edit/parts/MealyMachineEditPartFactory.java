 ...
 * @generated
 */
public class MealyMachineEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case HierarchyMealyMachineEditPart.VISUAL_ID:
				return new HierarchyMealyMachineEditPart(view);
			...
			case EdgeTriggerActionEditPart.VISUAL_ID:
				return new EdgeTriggerActionEditPart(view);
			}
		}
