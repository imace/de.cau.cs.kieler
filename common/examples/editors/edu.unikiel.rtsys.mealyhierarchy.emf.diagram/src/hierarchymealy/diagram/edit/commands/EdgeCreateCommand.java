...
public class EdgeCreateCommand extends CreateElementCommand {
	...
	public EdgeCreateCommand(CreateRelationshipRequest request, EObject source,
		...
		if (request.getContainmentFeature() == null) {
			setContainmentFeature(MealyPackage.eINSTANCE
					.getCompositeState_Edges());
		}
	...
	protected EObject doDefaultElementCreation() {
		Edge newElement = MealyFactory.eINSTANCE.createEdge();
	...
	protected EClass getEClassToEdit() {
		return MealyPackage.eINSTANCE.getCompositeState();
	}
