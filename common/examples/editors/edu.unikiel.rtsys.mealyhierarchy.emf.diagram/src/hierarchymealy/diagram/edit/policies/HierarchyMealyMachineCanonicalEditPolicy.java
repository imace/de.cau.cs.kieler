...
import hierarchymealy.diagram.part.MealyMachineLinkDescriptor;
 ...
 * @generated
 */
public class HierarchyMealyMachineCanonicalEditPolicy extends
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = MealyMachineVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				MealyMachineLinkDescriptor nextLinkDescriptor = (MealyMachineLinkDescriptor) LinkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final MealyMachineLinkDescriptor nextLinkDescriptor = (MealyMachineLinkDescriptor) linkDescriptorsIterator
					.next();
