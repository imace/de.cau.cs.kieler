...
import hierarchymealy.diagram.edit.helpers.MealyMachineBaseEditHelper;
 ...
 * @generated
 */
public class MealyMachineBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(MealyMachineVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					MealyMachineBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
