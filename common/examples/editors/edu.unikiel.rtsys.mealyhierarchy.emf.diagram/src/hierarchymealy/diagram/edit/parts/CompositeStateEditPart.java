...
import hierarchymealy.diagram.edit.policies.CompositeStateItemSemanticEditPolicy;
...
public class CompositeStateEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeStateItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompositeStateNameEditPart) {
			((CompositeStateNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MealyMachineVisualIDRegistry
	...
	public class CompositeStateFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureNodeNameFigure.setText("CompState");
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 246, 246, 246);
