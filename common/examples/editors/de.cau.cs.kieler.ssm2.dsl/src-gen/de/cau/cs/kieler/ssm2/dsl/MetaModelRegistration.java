...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://www.informatik.uni-kiel.de/rtsys/ssm2/dsl";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
   				try {
					EPackage pack = (EPackage) loadRootObject("de/cau/cs/kieler/ssm2/dsl/ssm2dl" + ".ecore");
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://www.informatik.uni-kiel.de/rtsys/ssm2/dsl");
	}
	...
	private static String getLanguagePath() {
	   return "de/cau/cs/kieler/ssm2/dsl/ssm2dl";
	}
