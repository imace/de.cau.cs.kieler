...
public void connectOutput(Wire w) {
	...
	if(type != null){
		...
		if(type.getName().equals(TransitionConnectionType.NAME)){
			...
			de.cau.cs.kieler.gems.mealy.mealymachine.Root r = (de.cau.cs.kieler.gems.mealy.mealymachine.Root)ModelRepository.getInstance().getInstanceRepository().getInstance(getModelInstanceID()).getRoot();
			if(r != null)
				r.addConnection(w);
...
public void disconnectInput(Wire w) {
	...
	if(type != null){
		...
		if(type.getName().equals(TransitionConnectionType.NAME)){
	        ...
	        ((de.cau.cs.kieler.gems.mealy.mealymachine.Root)ModelRepository.getInstance().getInstanceRepository().getInstance(getModelInstanceID()).getRoot()).removeConnection(w);
			TransitionConnection con = (TransitionConnection)w.getAttribute(TransitionConnectionType.NAME);
			if(con != null){
				con.setTarget(null);
