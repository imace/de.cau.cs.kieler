 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getX <em>X</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getY <em>Y</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getExpandedWidth <em>Expanded Width</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getExpandedHeight <em>Expanded Height</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#isExpanded <em>Expanded</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#isSubtype <em>Subtype</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#isVisible <em>Visible</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getModelLinkTarget <em>Model Link Target</em>}</li>
 *   <li>{@link de.cau.cs.kieler.gems.mealy.emf.mealymachine.impl.ModelObjectImpl#getAnnotation <em>Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
