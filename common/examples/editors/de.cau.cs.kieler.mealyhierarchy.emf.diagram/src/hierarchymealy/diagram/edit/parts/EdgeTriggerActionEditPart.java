 ...
 * @generated
 */
public class EdgeTriggerActionEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MealyMachineVisualIDRegistry
						.getType(hierarchymealy.diagram.edit.parts.EdgeTriggerActionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EdgeTriggerActionEditPart(View view) {
		super(view);
	}
