 ...
 * @generated
 */
public abstract class MealyMachineAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = MealyMachineDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected MealyMachineAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
