 ...
 * @generated
 */
public class MealyMachineDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MealyMachineDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MealyMachineDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((MealyMachineDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MealyMachineDomainNavigatorItem(
