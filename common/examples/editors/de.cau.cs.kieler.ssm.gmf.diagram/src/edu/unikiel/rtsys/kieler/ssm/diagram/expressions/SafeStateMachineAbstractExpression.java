 ...
 * @generated
 */
public abstract class SafeStateMachineAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SafeStateMachineDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SafeStateMachineAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
