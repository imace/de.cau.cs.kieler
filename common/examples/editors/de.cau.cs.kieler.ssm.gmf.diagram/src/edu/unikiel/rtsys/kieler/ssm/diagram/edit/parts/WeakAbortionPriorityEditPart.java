 ...
 * @generated
 */
public class WeakAbortionPriorityEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SafeStateMachineVisualIDRegistry
						.getType(edu.unikiel.rtsys.kieler.ssm.diagram.edit.parts.WeakAbortionPriorityEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public WeakAbortionPriorityEditPart(View view) {
		super(view);
	}
