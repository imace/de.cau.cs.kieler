...
import edu.unikiel.rtsys.kieler.ssm.diagram.edit.policies.SafeStateMachineTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WeakAbortionIsImmediateStringTriggeEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				SafeStateMachineVisualIDRegistry
						.getType(edu.unikiel.rtsys.kieler.ssm.diagram.edit.parts.WeakAbortionIsImmediateStringTriggeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public WeakAbortionIsImmediateStringTriggeEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof SafeStateMachineTextSelectionEditPolicy) {
			((SafeStateMachineTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					...
					SafeStateMachineEditPartFactory
