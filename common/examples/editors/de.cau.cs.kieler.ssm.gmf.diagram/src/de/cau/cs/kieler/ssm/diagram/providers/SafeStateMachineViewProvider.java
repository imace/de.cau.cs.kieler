...
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeState2ViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeStateCompositeStateCompartment2ViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeStateCompositeStateCompartmentViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeStateName2ViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeStateNameViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.CompositeStateViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.InitialStateViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.NormalTerminationEffectStringViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.NormalTerminationPriorityViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.NormalTerminationViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.RegionRegionCompartmentViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.RegionViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.SafeStateMachineViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.SimpleStateNameViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.SimpleStateViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.StrongAbortionIsImmediateStringTriggeViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.StrongAbortionPriorityViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.StrongAbortionViewFactory;
import de.cau.cs.kieler.ssm.diagram.view.factories.WeakAbortionIsImmediateStringTriggeViewFactory;
