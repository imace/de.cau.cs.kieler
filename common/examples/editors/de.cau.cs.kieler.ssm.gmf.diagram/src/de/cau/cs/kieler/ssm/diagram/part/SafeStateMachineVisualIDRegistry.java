...
public class SafeStateMachineVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return de.cau.cs.kieler.ssm.diagram.part.SafeStateMachineVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = de.cau.cs.kieler.ssm.diagram.part.SafeStateMachineVisualIDRegistry
		...
		if (SafeStateMachineEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = de.cau.cs.kieler.ssm.diagram.part.SafeStateMachineVisualIDRegistry
