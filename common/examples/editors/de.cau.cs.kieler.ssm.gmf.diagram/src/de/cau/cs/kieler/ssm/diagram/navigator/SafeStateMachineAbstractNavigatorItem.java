		...
		Platform.getAdapterManager().registerAdapters(
				new IAdapterFactory() {
					...
					public Object getAdapter(Object adaptableObject,
							Class adapterType) {
						if (adaptableObject instanceof de.cau.cs.kieler.ssm.diagram.navigator.SafeStateMachineAbstractNavigatorItem
				...
				de.cau.cs.kieler.ssm.diagram.navigator.SafeStateMachineAbstractNavigatorItem.class);
	}
