 ...
 * @generated
 */
public class SafeStateMachineCreationWizard extends Wizard implements
		INewWizard {
	 ...
	 * @generated
	 */
	protected SafeStateMachineCreationWizardPage diagramModelFilePage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(Messages.SafeStateMachineCreationWizardTitle);
		setDefaultPageImageDescriptor(SafeStateMachineDiagramEditorPlugin
	...
	public void addPages() {
		diagramModelFilePage = new SafeStateMachineCreationWizardPage(
				"DiagramModelFile", getSelection(), "ssm_diagram"); //$NON-NLS-1$ //$NON-NLS-2$
		diagramModelFilePage
				.setTitle(Messages.SafeStateMachineCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage
					...
					try {
						...
						ErrorDialog
								.openError(
										...
										Messages.SafeStateMachineCreationWizardOpenEditorError,
										null, e.getStatus());
					}
				}
			}
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog.openError(getContainer().getShell(),
						Messages.SafeStateMachineCreationWizardCreationError,
