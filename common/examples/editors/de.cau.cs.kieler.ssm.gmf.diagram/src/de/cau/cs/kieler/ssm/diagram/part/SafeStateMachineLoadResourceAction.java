 ...
 * @generated
 */
public class SafeStateMachineLoadResourceAction implements
		IObjectActionDelegate {

	/**
	 * @generated
	 */
	private SafeStateMachineEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof SafeStateMachineEditPart) {
				mySelectedElement = (SafeStateMachineEditPart) structuredSelection
						.getFirstElement();
			}
		}
