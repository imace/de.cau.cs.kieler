...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.ssm.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSubConditionsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Sub Conditions feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSubConditionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_subConditions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_subConditions_feature", "_UI_Condition_type"),
				 ssmPackage.Literals.CONDITION__SUB_CONDITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCombinationOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_combinationOperator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_combinationOperator_feature", "_UI_Condition_type"),
				 ssmPackage.Literals.CONDITION__COMBINATION_OPERATOR,
				 true,
				 false,
				 false,
	...
	protected void addLiteralsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_literals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_literals_feature", "_UI_Condition_type"),
				 ssmPackage.Literals.CONDITION__LITERALS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		CombinationOperator labelValue = ((Condition)object).getCombinationOperator();
