...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.ssm.SimpleState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleStateItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addStateFlagPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ssmPackage.Literals.NAMED__NAME,
				 true,
				 false,
				 false,
    ...
    /**
	 * This adds a property descriptor for the State Flag feature.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    protected void addStateFlagPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleState_stateFlag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleState_stateFlag_feature", "_UI_SimpleState_type"),
				 ssmPackage.Literals.SIMPLE_STATE__STATE_FLAG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
