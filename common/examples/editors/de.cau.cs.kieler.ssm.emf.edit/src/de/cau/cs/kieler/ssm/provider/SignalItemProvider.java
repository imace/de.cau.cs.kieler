...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.ssm.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_signalName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_signalName_feature", "_UI_Signal_type"),
				 ssmPackage.Literals.SIGNAL__SIGNAL_NAME,
				 true,
				 false,
				 false,
    ...
    public String getText(Object object) {
		String label = ((Signal)object).getSignalName();
