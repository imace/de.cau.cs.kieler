 ...
 * <ul>
 *   <li>{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnEntryAction <em>On Entry Action</em>}</li>
 *   <li>{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnInsideAction <em>On Inside Action</em>}</li>
 *   <li>{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnExitAction <em>On Exit Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState()
 * @model abstract="true"
...
public interface AbstractState extends EObject {
     ...
     * It is bidirectional and its opposite is '{@link edu.unikiel.rtsys.kieler.ssm.Transition#getTarget <em>Target</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState_IncomingTransitions()
     ...
     * The list contents are of type {@link edu.unikiel.rtsys.kieler.ssm.Transition}.
     * It is bidirectional and its opposite is '{@link edu.unikiel.rtsys.kieler.ssm.Transition#getSource <em>Source</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState_OutgoingTransitions()
     ...
     * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState_OnEntryAction()
    ...
    /**
     * Sets the value of the '{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnEntryAction <em>On Entry Action</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState_OnInsideAction()
     * @model transient="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnInsideAction <em>On Inside Action</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see edu.unikiel.rtsys.kieler.ssm.ssmPackage#getAbstractState_OnExitAction()
     * @model transient="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.unikiel.rtsys.kieler.ssm.AbstractState#getOnExitAction <em>On Exit Action</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
