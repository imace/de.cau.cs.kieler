...
import ssm.diagram.edit.commands.StateCreateCommand;
import ssm.diagram.providers.SsmElementTypes;

/**
 * @generated
 */
public class StateItemSemanticEditPolicy extends SsmBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	protected Command getCreateCommand(CreateElementRequest req) {
		if (SsmElementTypes.State_2002 == req.getElementType()) {
