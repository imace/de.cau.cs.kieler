...
import ssm.diagram.edit.policies.StateCanonicalEditPolicy;
import ssm.diagram.edit.policies.StateItemSemanticEditPolicy;
...
public class StateEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "ssm"; //$NON-NLS-1$
