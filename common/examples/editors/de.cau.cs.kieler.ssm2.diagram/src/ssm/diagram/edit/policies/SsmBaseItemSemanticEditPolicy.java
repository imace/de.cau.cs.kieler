...
import ssm.State;
import ssm.diagram.edit.helpers.SsmBaseEditHelper;
import ssm.diagram.part.SsmVisualIDRegistry;

/**
 * @generated
 */
public class SsmBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(SsmVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						SsmBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateTransition_4006(State container,
				State source, State target) {
			return canExistTransition_4006(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistTransition_4006(State container,
				State source, State target) {
