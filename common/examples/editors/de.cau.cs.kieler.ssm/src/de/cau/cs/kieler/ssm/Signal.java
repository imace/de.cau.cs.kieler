 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ssm.Signal#getSignalName <em>Signal Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.ssm.ssmPackage#getSignal()
 * @model
 * @generated
 */
public interface Signal extends EObject {
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#getSignal_SignalName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.ssm.Signal#getSignalName <em>Signal Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
