 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ssm.CompositeState#getRegions <em>Regions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ssm.CompositeState#getLocalSignals <em>Local Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ssm.CompositeState#getInputSignals <em>Input Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ssm.CompositeState#getOutputSignals <em>Output Signals</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.ssm.ssmPackage#getCompositeState()
...
public interface CompositeState extends SimpleState {
	 ...
	 * The list contents are of type {@link de.cau.cs.kieler.ssm.Region}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#getCompositeState_Regions()
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#getCompositeState_LocalSignals()
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#getCompositeState_InputSignals()
	 * @model containment="true" transient="true"
	 * @generated
	 */
	 ...
	 * @see de.cau.cs.kieler.ssm.ssmPackage#getCompositeState_OutputSignals()
	 * @model containment="true" transient="true"
	 * @generated
	 */
