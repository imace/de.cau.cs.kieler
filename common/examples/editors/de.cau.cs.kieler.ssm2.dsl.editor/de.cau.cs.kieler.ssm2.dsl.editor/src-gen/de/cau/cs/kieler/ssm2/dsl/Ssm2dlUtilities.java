...
public class Ssm2dlUtilities extends AbstractLanguageUtilities {

	// enforce eager registration of metamodel
	private static final EPackage EPACKAGE = de.cau.cs.kieler.ssm2.dsl.MetaModelRegistration.getEPackage();
	...
	public String getPackageForExtensions() {
		return "de::cau::cs::kieler::ssm2::dsl";
	}
