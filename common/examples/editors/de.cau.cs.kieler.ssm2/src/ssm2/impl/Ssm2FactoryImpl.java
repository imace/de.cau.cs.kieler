 ...
 * @generated
 */
public class Ssm2FactoryImpl extends EFactoryImpl implements Ssm2Factory {
	/**
	 ...
	 * @generated
	 */
	public static Ssm2Factory init() {
		try {
			Ssm2Factory theSsm2Factory = (Ssm2Factory)EPackage.Registry.INSTANCE.getEFactory("http://www.informatik.uni-kiel.de/rtsys/ssm2"); 
			if (theSsm2Factory != null) {
				return theSsm2Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Ssm2FactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Ssm2Package.STATE: return createState();
			case Ssm2Package.SIGNAL: return createSignal();
			case Ssm2Package.VALUE: return createValue();
			case Ssm2Package.EMISSION: return createEmission();
			case Ssm2Package.TRANSITION: return createTransition();
			case Ssm2Package.EXPRESSION: return createExpression();
			case Ssm2Package.SIGNAL_RENAMING: return createSignalRenaming();
			case Ssm2Package.OPERATOR: return createOperator();
			case Ssm2Package.ACTION: return createAction();
			case Ssm2Package.SUSPENSION_TRIGGER: return createSuspensionTrigger();
			case Ssm2Package.ASSIGNMENT: return createAssignment();
			case Ssm2Package.VARIABLE: return createVariable();
			default:
	 ...
	 * @generated
	 */
	public Ssm2Package getSsm2Package() {
		return (Ssm2Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Ssm2Package getPackage() {
		return Ssm2Package.eINSTANCE;
	}
