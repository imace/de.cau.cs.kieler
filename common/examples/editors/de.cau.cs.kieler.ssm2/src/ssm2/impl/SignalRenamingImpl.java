 ...
 * <ul>
 *   <li>{@link ssm2.impl.SignalRenamingImpl#getOldSignal <em>Old Signal</em>}</li>
 *   <li>{@link ssm2.impl.SignalRenamingImpl#getNewSignal <em>New Signal</em>}</li>
 *   <li>{@link ssm2.impl.SignalRenamingImpl#getParentState <em>Parent State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalRenamingImpl extends EObjectImpl implements SignalRenaming {
	...
	protected EClass eStaticClass() {
		return Ssm2Package.Literals.SIGNAL_RENAMING;
	}
		...
		if (oldSignal != null && oldSignal.eIsProxy()) {
			...
			if (oldSignal != oldOldSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ssm2Package.SIGNAL_RENAMING__OLD_SIGNAL, oldOldSignal, oldSignal));
			}
		}
		return oldSignal;
	}
	...
	public void setOldSignal(Signal newOldSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ssm2Package.SIGNAL_RENAMING__OLD_SIGNAL, oldOldSignal, oldSignal));
	}
	...
	public Signal getNewSignal() {
		if (newSignal != null && newSignal.eIsProxy()) {
			...
			if (newSignal != oldNewSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ssm2Package.SIGNAL_RENAMING__NEW_SIGNAL, oldNewSignal, newSignal));
			}
		}
		return newSignal;
	}
	...
	public void setNewSignal(Signal newNewSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ssm2Package.SIGNAL_RENAMING__NEW_SIGNAL, oldNewSignal, newSignal));
	}
	...
	public State getParentState() {
		if (eContainerFeatureID != Ssm2Package.SIGNAL_RENAMING__PARENT_STATE) return null;
	...
	public NotificationChain basicSetParentState(State newParentState, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParentState, Ssm2Package.SIGNAL_RENAMING__PARENT_STATE, msgs);
		return msgs;
	}
	...
	public void setParentState(State newParentState) {
		if (newParentState != eInternalContainer() || (eContainerFeatureID != Ssm2Package.SIGNAL_RENAMING__PARENT_STATE && newParentState != null)) {
			...
			if (newParentState != null)
				msgs = ((InternalEObject)newParentState).eInverseAdd(this, Ssm2Package.STATE__SIGNAL_RENAMINGS, State.class, msgs);
			msgs = basicSetParentState(newParentState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ssm2Package.SIGNAL_RENAMING__PARENT_STATE, newParentState, newParentState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ssm2Package.SIGNAL_RENAMING__PARENT_STATE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case Ssm2Package.SIGNAL_RENAMING__PARENT_STATE:
				return eInternalContainer().eInverseRemove(this, Ssm2Package.STATE__SIGNAL_RENAMINGS, State.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ssm2Package.SIGNAL_RENAMING__OLD_SIGNAL:
				if (resolve) return getOldSignal();
				return basicGetOldSignal();
			case Ssm2Package.SIGNAL_RENAMING__NEW_SIGNAL:
