 ...
 * <ul>
 *   <li>{@link ssm.SuspensionTrigger#getParentState <em>Parent State</em>}</li>
 *   <li>{@link ssm.SuspensionTrigger#isImmediate <em>Immediate</em>}</li>
 * </ul>
 * </p>
 *
 * @see ssm.ssmPackage#getSuspensionTrigger()
 * @model
 * @generated
 */
public interface SuspensionTrigger extends Trigger {
	/**
	 * Returns the value of the '<em><b>Parent State</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link ssm.State#getSuspensionTrigger <em>Suspension Trigger</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ssm.ssmPackage#getSuspensionTrigger_ParentState()
	...
	/**
	 * Sets the value of the '{@link ssm.SuspensionTrigger#getParentState <em>Parent State</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ssm.ssmPackage#getSuspensionTrigger_Immediate()
	 * @model
	 * @generated
	 */
	boolean isImmediate();
	...
	/**
	 * Sets the value of the '{@link ssm.SuspensionTrigger#isImmediate <em>Immediate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
