 ...
 * <ul>
 *   <li>{@link ssm.Signal#getValue <em>Value</em>}</li>
 *   <li>{@link ssm.Signal#getName <em>Name</em>}</li>
 *   <li>{@link ssm.Signal#getParentState <em>Parent State</em>}</li>
 *   <li>{@link ssm.Signal#isIsLocal <em>Is Local</em>}</li>
 *   <li>{@link ssm.Signal#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link ssm.Signal#isIsOutput <em>Is Output</em>}</li>
 * </ul>
 * </p>
 *
 * @see ssm.ssmPackage#getSignal()
 * @model
 * @generated
 */
public interface Signal extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link ssm.Value#getParentSignal <em>Parent Signal</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setValue(Value)
	 * @see ssm.ssmPackage#getSignal_Value()
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#getValue <em>Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see ssm.ssmPackage#getSignal_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ssm.State#getSignals <em>Signals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ssm.ssmPackage#getSignal_ParentState()
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#getParentState <em>Parent State</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ssm.ssmPackage#getSignal_IsLocal()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsLocal();
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#isIsLocal <em>Is Local</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ssm.ssmPackage#getSignal_IsInput()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsInput();
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#isIsInput <em>Is Input</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ssm.ssmPackage#getSignal_IsOutput()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsOutput();
	...
	/**
	 * Sets the value of the '{@link ssm.Signal#isIsOutput <em>Is Output</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
