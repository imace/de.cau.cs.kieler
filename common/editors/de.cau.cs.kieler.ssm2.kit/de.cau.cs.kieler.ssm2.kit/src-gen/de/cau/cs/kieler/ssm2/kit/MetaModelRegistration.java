...
package de.cau.cs.kieler.ssm2.kit;
...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://kieler.cs.cau.de/kit";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
   				try {
					EPackage pack = (EPackage) loadRootObject("de/cau/cs/kieler/ssm2/kit/kit" + ".ecore");
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://kieler.cs.cau.de/kit");
	}
	...
	private static String getLanguagePath() {
	   return "de/cau/cs/kieler/ssm2/kit/KIT";
	}
