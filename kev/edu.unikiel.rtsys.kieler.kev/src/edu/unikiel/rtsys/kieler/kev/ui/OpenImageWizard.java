package edu.unikiel.rtsys.kieler.kev.ui;
...
public class OpenImageWizard extends Wizard {
	...
	public final static String IMAGE_EXTENSION_POINT_ID = "edu.unikiel.rtsys.kieler.kev.image";
	...
	private class OpenImageWizardPage extends WizardPage implements SelectionListener, MouseListener{
		...
		public void createControl(Composite parent) {
			...
			checkboxLabel.setText("Remember filename for next startup: ");
